...
<head>
<title>MahaSevaarth DCPS Legacy Data Status</title>
...
$('#example').append('<caption style="caption-side: top">Customised Sevaarth Paybill Status Report</caption>');
...
<a href=""><img src="images/mahasevaarth.png" id="image"
	name="image" crossorigin="anonymous" style="display: none;"></a>
<!-- Added Brijoy  -->
<div class="container body-contents">
	<div class="hearder-top">
				...
				<div class="col-md-9 flex">
					<div class="logobar ">
						<a class="logo" href="index.html"><img
							src="images/logo-v16.png" class="logo-img"></a>
					</div>
					<h5 class="logo-Title">
		...
		<h2 align="center">
			<font><strong>HTESevaarth DCPS Legacy Data Status
					Report</strong></font>
		</h2>
