...
import com.tcs.sgv.nps.dao.NpsGrossExpenditureReportDAOImpl;

public class NpsGrossExpenditureReportServiceImpl extends DefaultReportDataFinder implements ReportDataFinder{
	...
	private NpsGrossExpenditureReportDAOImpl gObjRptQueryDAO = null;
	...
	public Collection findReportData(ReportVO lObjReport, Object criteria) throws ReportException {
		...
		try {
			...
			gObjRptQueryDAO = new NpsGrossExpenditureReportDAOImpl(null, gObjSessionFactory);
			...
			if (lObjReport.getReportCode().equals("80000953")) {
				lLstDataList = getNpsExpenditureReport(lObjReport, gStrLocCode,ddocode);
			}
	...
	private List getNpsExpenditureReport(ReportVO lObjReport, String lStrLocCode, String ddocode) {
		
		System.out.println("Hiiii i am here");	
		List lArrReturn = new ArrayList();
		
		NpsGrossExpenditureReportDAOImpl gObjRptQueryDAO = new NpsGrossExpenditureReportDAOImpl(null, gObjSessionFactory);
		...
		try {
			...
			lArrReturn=gObjRptQueryDAO.getNpsExpenditureReport(lStrLocCode, ddocode);
		}
