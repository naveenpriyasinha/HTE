...
<body>
<hdiits:form name="frmBillTrnsitRegAdtIn" validate="true" >
<hdiits:table width="90%" align="center" rules="TablerowBG2">
	<hdiits:tr>
		<hdiits:td align="center">
			<b>Treasury > Bill Processing > Audit Branch > Reports > Bill Transit Register For Audit</b>
		</hdiits:td>
	</hdiits:tr>
				...
				<hdiits:tr>
					...
					<hdiits:td>
						:&nbsp;<hdiits:select name="cmbStatus">
							<hdiits:option value="0" >------Select------</hdiits:option>
							<hdiits:option value="1" >Approved</hdiits:option>
							<hdiits:option value="2" >Reject</hdiits:option>
						</hdiits:select>
					</hdiits:td>
	...
	<hdiits:tr>
		<hdiits:td>
			<center>
				<hdiits:button type="button" name="btnGenRpt" value="Generate Report" onclick="javascript:showRpt('ifms.htm?viewName=adtBillTrnsitRegAdtRpt');"></hdiits:button>
