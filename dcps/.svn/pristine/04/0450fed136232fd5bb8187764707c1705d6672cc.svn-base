...
<div id="asset" name="asset">
    ...
    <tr></tr>
    <tr>
    <TD class=fieldLabel  align="center"><b><fmt:message key="ASSET_REQ_NO" bundle="${a4}"/> ${showreqId} <fmt:message key="REQ_APPROVE_SEND" bundle="${a4}"/> ${RequestedUser}/${RequestedDesignation} </b></TD>
	</tr>
	<tr></tr>
    <tr></tr>
