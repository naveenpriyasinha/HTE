...
<script type="text/javascript">
	...
	function submitReq()
	{	
		document.forms[0].action = "hrms.htm?actionFlag=AwardCertiAppr&flag=1";
...
<c:set var="InteCer" value="${resValue.InteCer}" > </c:set>
...
<hdiits:fieldGroup bundle="${awdlbl}" titleCaptionId="ess.inteCerti" id="inteCertiHeader" collapseOnLoad="false">			
<BR>
...
<BR>
    ...
    <tr>
		...
		<hdiits:caption captionid="ess.Inte1" bundle="${awdlbl}" captionLang="single"></hdiits:caption>
		<c:out value="${EmpName}"></c:out> 
		<hdiits:caption captionid="ess.Inte2" bundle="${awdlbl}" captionLang="single"></hdiits:caption>
		<c:out value="${EmpDesig}"></c:out>&nbsp;<c:out value="${EmpCity}"></c:out>
		<BR><hdiits:caption captionid="ess.Inte3" bundle="${awdlbl}" captionLang="single"></hdiits:caption>
		<hdiits:caption captionid="ess.Inte4" bundle="${awdlbl}" captionLang="single"></hdiits:caption>
		<BR><hdiits:caption captionid="ess.Inte5" bundle="${awdlbl}" captionLang="single"></hdiits:caption>
		<hdiits:caption captionid="ess.Inte6" bundle="${awdlbl}" captionLang="single"></hdiits:caption>
		<BR><hdiits:caption captionid="ess.Inte7" bundle="${awdlbl}" captionLang="single"></hdiits:caption>
		<hdiits:caption captionid="ess.Inte8" bundle="${awdlbl}" captionLang="single"></hdiits:caption>
		<BR><hdiits:caption captionid="ess.Inte9" bundle="${awdlbl}" captionLang="single"></hdiits:caption>
		<hdiits:caption captionid="ess.Inte10" bundle="${awdlbl}" captionLang="single"></hdiits:caption>
		<BR><hdiits:caption captionid="ess.Inte11" bundle="${awdlbl}" captionLang="single"></hdiits:caption>
		<hdiits:caption captionid="ess.Inte12" bundle="${awdlbl}" captionLang="single"></hdiits:caption>
		<BR><hdiits:caption captionid="ess.Inte13" bundle="${awdlbl}" captionLang="single"></hdiits:caption>
		<hdiits:caption captionid="ess.Inte14" bundle="${awdlbl}" captionLang="single"></hdiits:caption>       
		</b></font></p></td>
		<td></td>
	</tr>
