...
<div id="tabmenu">
		<ul id="maintab" class="shadetabs">
			<li class="selected"><a href="#" rel="tcontent1"><hdiits:caption captionid="TR.SelectTrngSch" bundle="${trngLables}"></hdiits:caption> </a></li>
		</ul>
</div>

<div id="tcontent1" class="tabcontent" tabno="0">
<fmt:message key="TR.SEARCH_ATTENDANCE"  bundle="${trngLables}" var="trngSearchTitle"></fmt:message>
<TABLE class="tabtable">
<tr>  
	<td class="fieldLabel" colspan="6">
	<jsp:include page="trngSheduleSearch.jsp">
		<jsp:param name="searchTrngTitle" value="${trngSearchTitle}"/>
