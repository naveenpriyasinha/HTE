...
<fmt:setBundle basename="resources.hr.review.MedicalReviewLabels" var="commonLables" scope="request" />
...
<hdiits:caption captionid="EMPLOYEE.REVIEW" bundle="${commonLables}"></hdiits:caption></b></a></li>
