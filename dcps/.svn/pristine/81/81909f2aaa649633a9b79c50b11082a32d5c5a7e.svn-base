...
<c:set var="recoveryLetter" value="${resValue.DisplayRecoveryLetterString}"></c:set>
<input type="hidden" id="hdnRecoveryLetter" name="hdnRecoveryLetter" value="${resValue.PrintRecoveryLetterString}"/>
<script>
function printRecoveryLetter()
{
    ...
    var printString = document.getElementById("hdnRecoveryLetter").value;
...
<hdiits:form name="frmPrintRecoveryLetter" validate="false">
<br>
<div align="center"><h5><fmt:message key="PPMT.RECOVERYLETTER" bundle="${pensionLabels}" ></fmt:message></h5></div>
	...
	<div align="center">
	<hdiits:button type="button" captionid="PPMT.PRINTREPORT" bundle="${pensionLabels}" id="btnPrintReport" name="btnPrintReport" onclick="printRecoveryLetter()" classcss="bigbutton"/>
