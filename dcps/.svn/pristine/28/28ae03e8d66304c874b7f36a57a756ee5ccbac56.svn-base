...
<script type="text/javascript">
	...
	function submitReq()
	{
		document.forms[0].action = "hrms.htm?actionFlag=AwardCertiAppr&flag=4";
...
<c:set var="ReaRecCer" value="${resValue.ReaRecCer}" ></c:set>
...
<hdiits:fieldGroup bundle="${awdlbl}" titleCaptionId="ess.RecommCerti" id="recomCertiHeader" collapseOnLoad="false">			
<BR>
...
<BR>
    ...
    <tr>
		...
		<hdiits:caption captionid="ess.recomm1" bundle="${awdlbl}" captionLang="single"></hdiits:caption>
		<c:out value="${EmpName}"></c:out><BR>
		<hdiits:caption captionid="ess.recomm2" bundle="${awdlbl}" captionLang="single"></hdiits:caption> 
		<c:out value="${EmpDesig}"></c:out>&nbsp;<c:out value="${EmpCity}"></c:out><BR>
		<hdiits:caption captionid="ess.recomm4" bundle="${awdlbl}" captionLang="single"></hdiits:caption>
		<BR>
		<hdiits:caption captionid="ess.recomm5" bundle="${awdlbl}" captionLang="single"></hdiits:caption>
		<hdiits:caption captionid="ess.recomm6" bundle="${awdlbl}" captionLang="single"></hdiits:caption>
		</b></font></p></td>
		<td></td>
	</tr>
