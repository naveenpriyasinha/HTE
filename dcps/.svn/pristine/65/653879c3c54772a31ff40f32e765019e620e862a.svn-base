...
<body>
<hdiits:form name="frmBillTypeIn" validate="true" >
<hdiits:table width="90%" align="center" rules="TablerowBG2">
	<hdiits:tr>
		<hdiits:td align="center">
			<b>Treasury > Bill Processing > Audit Branch > Reports > Auditor wise Bill Type Report</b>
		</hdiits:td>
	</hdiits:tr>
	...
	<hdiits:tr align="center">
		<hdiits:td >
			<b>Auditor wise Bill Type Report</b>
		</hdiits:td>
	</hdiits:tr>
	<hdiits:tr><hdiits:td><br></hdiits:td></hdiits:tr>
	<hdiits:tr>
				...
				<hdiits:tr>
					...
					<hdiits:td>
						:&nbsp;<hdiits:select name="cmbBillType">
							...
							<hdiits:option value="1" >TC</hdiits:option>
							<hdiits:option value="2" >Zero</hdiits:option>
							<hdiits:option value="3" >Nil Bill</hdiits:option>
						</hdiits:select>
					</hdiits:td>
					<hdiits:td>
	...
	<hdiits:tr>
		<hdiits:td>
			<center>
				<hdiits:button type="button" name="btnGenRpt" value="Generate Report" onclick="javascript:showRpt('ifms.htm?viewName=adtBillTypeRpt');"></hdiits:button>
