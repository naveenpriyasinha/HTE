...
function clearForm(){
	...
	document.getElementById('sebcCat').value="";
	document.getElementById('sebcCat').readonly="";
	document.getElementById('phCat').value="";
	document.getElementById('phCat').readonly="";
...
function addRecord()
{
	if (xmlHttp.readyState == 4) 
	{
		...
		else
		{
			...
			document.getElementById('sebcCat').value=paraArray[2];
			document.getElementById('sebcCat').readonly="true";
			document.getElementById('phCat').value=paraArray[3];
			document.getElementById('phCat').readonly="true";
...
function submitDtls()
{
	...
	var urlstyle="hdiits.htm?actionFlag=setMstDtls";
	document.frm1.action=urlstyle;
	document.frm1.submit();
}
function closeWindows()
...
function enableDsgn(){
document.getElementById('dsgn').disabled=false;
}