...
<hdiits:hidden name="actionFlag" default="getNominationDetails"/>
...
<tr>
	<td class="fieldLabel" colspan="6" align="center"><hdiits:formSubmitButton name="formApproveButton" type="button" captionid="TR.SUBMIT" bundle="${trngLables}"/></td>
</tr>
</TABLE>
