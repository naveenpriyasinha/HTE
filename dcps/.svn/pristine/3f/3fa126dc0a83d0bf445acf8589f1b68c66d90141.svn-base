...
<script type="text/javascript" src="script/hrms/hr/rosterScript/promRosterReqPage.js">
</script>
<script type="text/javascript"
...
function formValidate()
{
	...
	var totalSum=document.getElementById("scCat").value*1+document.getElementById("stCat").value*1;
	if(totalSum>100)
	{
...
<hdiits:form name="frm1" validate="true" method="POST"
	...
	<table border="0" width="90%" align="center">
		...
		<tr>
			<td style="display:none" id="lblSubDsgn"><hdiits:caption captionid="Hr_lbl_sub_designation"
				bundle="${caption}"  /></td>
			<td style="display:none" id="cmbSubDsgnCol"><hdiits:select name="subdsgn" size="1" caption="subdsgn" id="subdsgn"
				tabindex="3" onchange="checkForApprove()" >
				<hdiits:option value="-1">------Select -----</hdiits:option>
			</hdiits:select></td>
			<td><hdiits:caption captionid="Hr_lbl_vac" bundle="${caption}" />
			</td>
			<td><hdiits:number name="vac" id="vac" maxlength="3" size="3" onblur="checkDecimalInBox(this)" /></td>
		</tr>
		<tr>
			<td>&nbsp</td>
		</tr>
		...
		<tr>
			...
			<td><hdiits:number name="scCat" maxlength="2" size="3" onblur="checkDecimalInBox(this)"  /><strong>%</strong> </td>
			<td><hdiits:caption captionid="Hr_stlabl" bundle="${caption}" />
			</td>
			<td><hdiits:number name="stCat" maxlength="2" size="3" onblur="checkDecimalInBox(this)"  /><strong>%</strong> </td>
		</tr>
		<tr>
			<td>&nbsp</td>
		</tr>
		...
		<tr>
			...
			<center>
			<hdiits:button name="SubmitBt" type="button" id="SubmitBt" value="Submit" onclick="submitDtls()"/>
			<hdiits:button name="Close" type="button" value="Close" onclick="closeWindows()"/>
			</center>
	...
	<hdiits:hidden name="rosterType" id="rosterType" default="P" />
