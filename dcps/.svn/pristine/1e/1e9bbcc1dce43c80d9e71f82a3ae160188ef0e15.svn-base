...
<script type="text/javascript">
	...
	function submitReq()
	{
		document.forms[0].action = "hrms.htm?actionFlag=AwardCertiAppr&flag=3";
...
<c:set var="NoEnqCer" value="${resValue.NoEnqCer}" ></c:set>
...
<hdiits:fieldGroup bundle="${awdlbl}" titleCaptionId="ess.noInqCerti" id="noInqCertiHeader" collapseOnLoad="false">			
<BR>
...
<BR>
    ...
    <tr>
		...
		<hdiits:caption captionid="ess.Noenq1" bundle="${awdlbl}" captionLang="single"></hdiits:caption>
		<BR><hdiits:caption captionid="ess.Noenq2" bundle="${awdlbl}" captionLang="single"></hdiits:caption>
		 <c:out value="${EmpName}"></c:out><BR><hdiits:caption captionid="ess.Noenq3" bundle="${awdlbl}" captionLang="single"></hdiits:caption>
		  <c:out value="${EmpDesig}"></c:out>&nbsp;<c:out value="${EmpCity}"></c:out> 
		 <BR><hdiits:caption captionid="ess.Noenq4" bundle="${awdlbl}" captionLang="single"></hdiits:caption> 
		 <BR><hdiits:caption captionid="ess.Noenq5" bundle="${awdlbl}" captionLang="single"></hdiits:caption>
		 <BR><hdiits:caption captionid="ess.Noenq6" bundle="${awdlbl}" captionLang="single"></hdiits:caption> 
		</b></font></p></td>
		<td></td>
	</tr>
...
<BR>
	...
	<c:if test="${NoEnqCer eq 'N'}">
	<hdiits:radio captionid="ess.Agree" bundle="${awdlbl}" name="ApprRejec" value="Y"
				mandatory="false" />
	<hdiits:radio captionid="ess.Disagree" bundle="${awdlbl}" name="ApprRejec" value="N"	mandatory="false"  default="N" /></strong></center>
	</c:if>
	
	<c:if test="${NoEnqCer eq 'Nil'}">
	<hdiits:radio captionid="ess.Agree" bundle="${awdlbl}" name="ApprRejec" value="Y"
				mandatory="false" />
	<hdiits:radio captionid="ess.Disagree" bundle="${awdlbl}" name="ApprRejec" value="N" 
