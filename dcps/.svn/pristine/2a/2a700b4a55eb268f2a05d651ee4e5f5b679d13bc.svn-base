...
<c:set var="DisplayJobTitle" value="${resValue.DisplayJobTitle}"> </c:set>
<c:set var="Flag" value="${resValue.DisplayJobTitle}"> </c:set>
<c:set var="FromPostId" value="${resValue.FromPostId}"> </c:set>
<fmt:setBundle basename="resources.ess.wll.wll" var="commonLables" scope="request"/>
<hdiits:form name="welfareentry" validate="true" method="POST"  encType="multipart/form-data"
	>
...
<table width="100%" align="center">
  ...
  <tr  ></tr>
    ...
    <tr><th align="center">
    <b><hdiits:caption captionid="HR.EIS.WelfReq" bundle="${commonLables}"/></b>
	
    <c:out value=" ${DisplayJobTitle} "></c:out>
    
    <b><hdiits:caption captionid="HR.EIS.Approved" bundle="${commonLables}"/></b>
