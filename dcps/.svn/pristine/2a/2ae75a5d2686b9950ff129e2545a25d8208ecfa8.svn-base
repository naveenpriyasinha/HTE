...
<body>
<hdiits:form name="frmBillTrnsitRegIn" validate="true" >
<hdiits:table width="90%" align="center" rules="TablerowBG2">
	...
	<hdiits:tr>
		<hdiits:td>
			<center>
				<hdiits:button type="button" name="btnGenRpt" value="Generate Report" onclick="javascript:showRpt('ifms.htm?viewName=adtBillTrnsitRegRpt');"></hdiits:button>
