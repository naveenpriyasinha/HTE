      ...
      for (var y = 0, keyid = "", ex; ex = elem[y++];) {
        if ((ex.nodeName == "TEXTAREA" || ex.type == "text" || ex.type == "password") && ex.className.indexOf("keyboardInput") > -1) {
          ...
          var keybut = document.createElement('img');
              ...
              //keybut.src = "themes/" + vThemename + "/images/keyboard.png"; 
              ...
              //keybut.onmouseover = (function(b){showPwdSecurityTip();});
              //keybut.onmouseout = (function(b){UnTip();});
	          document.all.vKeyboard.insertBefore(keybut);
