...
<hdiits:form name="frm_auditorInput" validate="true" method="post" action="ifms.htm?actionFlag=genAudWiseDailyVito&vitoType=71">
<table border="1" cellspacing="0" cellpadding="0" align="center" width="90%">
	<tr class="datatableheader"> 
	    <td  align="center"><fmt:message key="AUDITORLIST.TITLE" bundle="${billProcLabels}"></fmt:message></td>
	</tr>
	<tr>
	<td>
