...
<br/>
<br/>
<hdiits:form name="Errorfrm" validate="true" action="hdiits.htm?actionFlag=getEmpSearchSelData&code=LE&multiple=false" method="post"	encType="multipart/form-data">
