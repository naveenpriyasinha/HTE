...
{	
	...
	if(radioValue=="Stop3rdCF"){
		window.returnValue = "Stop3rdCF";
	}
	else if(radioValue=="Want3rdCF"){
		window.returnValue = "Want3rdCF";
	}	
...
<table width="100%">
	<tr>
		<td width="1%"><input type="radio" name="rdoDisburse" id="rdoWant3ndDisburse" value="Want3rdCF" checked="checked"/></td>
		<td width="99%"><fmt:message key="CMN.OPTION2FORCF" bundle="${lnaLabels}"></fmt:message></td>
	</tr>
	<tr>	
		<td width="1%"><input type="radio" name="rdoDisburse" id="rdoStop3ndDisburse" value="Stop3rdCF"/></td>
		<td width="99%"><fmt:message key="CMN.OPTION5FORCF" bundle="${lnaLabels}"></fmt:message></td>
	</tr>
	<tr>						
