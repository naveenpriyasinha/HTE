...
<c:set var="netInWrds" value="${resultValue.netPayInWords}" > </c:set>
<c:set var="grossInWrds" value="${resultValue.grossPayInWords}" > </c:set>
...
<c:set var="majorhead " value="${resultValue.majorhead }" > </c:set>
<c:set var="minorHead " value="${resultValue.minorHead }" > </c:set>
<c:set var="subHead " value="${resultValue.subHead }" > </c:set>
<c:set var="schemeName " value="${resultValue.schemeName }" > </c:set>
<c:set var="schemeCode " value="${resultValue.schemeCode }" > </c:set>
<c:set var="demandCode " value="${resultValue.demandCode }" > </c:set>
<c:set var="net " value="${resultValue.net }" > </c:set>
<c:set var="gross " value="${resultValue.gross }" > </c:set>
<c:set var="pt " value="${resultValue.pt }" > </c:set>
<c:set var="pf" value="${resultValue.pf" > </c:set>
		...
		<td colspan="2" align="center">
				...
				<tr>
						...
						<table align="left">
							<tr>
								<td align="left">
									...
									<table>
										<tr>
											<td><center><u>HEAD OF ACCOUNT</u></center></td>
											<td></td>
										</tr>
										<tr>
					...
					<td width="50%" valign="top" height="100px">
						<table cellpadding="2" cellspacing="0" border="1" height="100%"
							...
							<tr>
								<td colspan="2"><center>For Use In Treasury</center>
									</td>
							</tr>
							<tr align="left">
							<td>Voucher NO.</td>
							...
							width="100%">
							<tr>
								<td colspan="2"><center>Name Of Treasury/Sub-Treasury</center>
									</td>
							</tr>
							<tr >
			...
			<table cellpadding="2" cellspacing="0" border="1" 
							...
							<tr>
								...
								<td width="20%">
								<span id="leftstart">
								<c:out value="${grossInWrds}" />
							</span>
							</td><td width="80%">
							<span id="subsisides">
							<center>Grant-in-aid/Contribution/Subsidies
							<br>
							(Full Details of the Claim)<br>
							<b> Salary For The Month&nbsp;&nbsp;<c:out value="${month}" />&nbsp;<c:out value="${year}" /></b>
							<b><br>
							To SECONDARY SCHOOL
							(Grant-in-Aid Bill)</center></b>
				...
				<td width="50%" valign="top">
					<table cellpadding="2" cellspacing="0" border="1" height="100%"
							...
							<b><center>Prov. Fund</center></b>				
								...
								<td width="50%">
							<center><c:out value="${pf]}" /></center>
							</td>
							</tr>
							
							<tr>
							<td width="50%">	
							<b><center>P T</center></b>				
							</td>
								<td width="50%">
			...
			<p>Amount&nbsp;&nbsp;(in Words) Rupees &nbsp;&nbsp;&nbsp;<b><c:out value="${net}" />/-&nbsp;&nbsp; <c:out value="${netInWrds}" /> Only</b>
			</p>
			</td>
			</tr>
			<tr>
			<td colspan="2" width="100%" align="left">
			<p>Received The Sum Of Rs.&nbsp;&nbsp;&nbsp;<b> <c:out value="${gross}" />/-&nbsp;&nbsp;  <c:out value="${grossInWrds}" /> Only</b>
			<br><br>
			being the amount sactioned for the period<b> <c:out value="${month}" />&nbsp;<c:out value="${year}" /> </b>under<b> <c:out value="${deptName}" /></b>
			<br>
			No. Pay Unit/Salary &nbsp;&nbsp;&nbsp;dated<b> &nbsp;<fmt:formatDate pattern="yyyy-MM-dd"value="${date}" /> </b>&nbsp;&nbsp;&nbsp;<c:out value="${currentDate}" />&nbsp;&nbsp;&nbsp;&nbsp;(Copy enclosed) for disbursememnt to 
			</p>
			</td>
			</tr>
			<tr>
			...
			<b>Certified That:-
			<br>
			(i)The grantee has executed the requisite bond/ has bee exempted from executing a bond.In Consultation with Finance Department/Law and Judiciary Department.
			<br>
			(ii)I have no reason to belebve that the grantee institution is involved in corrupt practices.<br>
			<b>Place:
			<br>
