...
function saveData()
{	
	opener.document.Roster.textData.value=document.getElementById('txtData').value;	
...
<div class="tabcontentstyle">
	<div id="tcontent1" class="tabcontent" tabno="0">
		<center>
			<hdiits:textarea name="txtData" cols="70" rows="10" caption="Remarks" id="txtData" maxlength="2000">
			</hdiits:textarea>
			<BR>
			<BR>
...
<script type="text/javascript">
		...
		document.getElementById('txtData').value=opener.document.Roster.textData.value;		
		if(opener.document.Roster.rwFlag.value=="R"){
