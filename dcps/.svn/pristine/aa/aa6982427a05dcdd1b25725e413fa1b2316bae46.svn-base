...
<c:set  var="showreqId" value="${resValue.pkval}"></c:set>
<c:set  var="userName" value="${resValue.fwdTo}"></c:set>

<body>
<hdiits:form name="approveAsset" validate="true" method="POST" encType="multipart/form-data">
<div id="tabmenu">
	<ul id="maintab" class="shadetabs">
		<li class="selected"><a href="#" rel="tcontent1"><b><fmt:message key="PER_PUR_SALE" bundle="${a2}"/></b></a></li>
	</ul>
</div>
<div id="asset" name="asset">
    ...
    <tr></tr>
    <tr>
	<TD class=fieldLabel  align="center"><b><fmt:message key="ASSET_CORRS_NO" bundle="${a2}"/> ${showreqId} <fmt:message key="ASSET_FORWARD" bundle="${a2}"/> ${userName} <fmt:message key="ASSET_APPROVE" bundle="${a2}"/></b></TD>
	</tr>
	<tr></tr>
    <tr></tr>
