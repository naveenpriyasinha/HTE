...
<c:set var="allow" value="${resultValue.allowDed}"> </c:set>
<c:set var="lstGpf" value="${resultValue.lstGpf}">
</c:set>
<c:set var="consolidatedGpfMap" value="${resultValue.consolidatedGpfMap}">
</c:set>
<c:set var="provFundNormalMap" value="${resultValue.provFundNormalMap}"></c:set>
<c:set var="emptyVar" value="-"></c:set>
...
<!-- <tr align="right">
		...
		<table cellpadding="0" cellspacing="0" align="CENTER" width="100%"
				...
				<table align="left">
					<tr>
						...
						<table>
							...
							<tr>
								<td>Scheme Name</td>
								<td>:<c:out value="${schemeName}" /></td>

							</tr>
							<tr>
								<td>Scheme Code</td>
								<td>:<c:out value="${schemeCode}" /></td>
			...
			<tr>
				...
				<c:forEach items="${provFundNormalMap}" var="provFundNormal">
					...
					<tr>
						<td width="25%"><b>
						<center>DCPS/NPS EMP Contribution</center>
						</b></td>
	...
	<c:choose>
				...
				<c:otherwise>
					<td width="25%">
						<center><c:out value="8342519701/8342513201" /></center>
						</td>
					<td width="25%">
				   <b><center><c:out value="${dcps}" /></center></b>				
						...
						<%-- <td width="25%">
								<c:if test="${dcps ge 0 && npsEmplrDeduc ge 0}">
				        <b><center> 8342519701&nbsp;&nbsp;(Amount: <c:out value="${dcps}" />)</center></b></c:if>						
				        </td>
					...
					<tr>
						<td width="25%"><b>
						<center>NPS EMPLR Contribution(14%)</center>
						</b></td>
					...
					<tr>
						...
						<td width="25%">
						<c:if test="${allow[0][4] ne null}">
							<center><c:out value="${allow[0][4]}" /></center>
						</c:if>
						<c:if test="${allow[0][4] eq null}">
							<center>-</center>
						</c:if>
