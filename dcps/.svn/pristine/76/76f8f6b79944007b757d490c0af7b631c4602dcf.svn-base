...
window.addEventListener('DOMContentLoaded', (event) => {
	if (location.href.match("80000952")) {
		    var a = document.body;
		a.classList ? a.classList.add('EmployeeRetired') : a.className += ' EmployeeRetired';
	}
	if (location.href.match("80000951")) {
		    var a = document.body;
		a.classList ? a.classList.add('EmployeeRetired') : a.className += ' EmployeeRetired';
	}
	if (location.href.match("80000953")) {
		    var a = document.body;
		a.classList ? a.classList.add('EmployeeRetired') : a.className += ' EmployeeRetired';
	}
	if (location.href.match("80000950")) {
		    var a = document.body;
		a.classList ? a.classList.add('EmployeeRetired') : a.className += ' EmployeeRetired';
	}
	if (location.href.match("80000949")) {
		    var a = document.body;
		a.classList ? a.classList.add('EmployeeRetired') : a.className += ' EmployeeRetired';
	}
