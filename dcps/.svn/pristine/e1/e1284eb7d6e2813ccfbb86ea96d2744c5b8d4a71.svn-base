...
//	alert(locCode);
	var url;
		...
		url="./hrms.htm?actionFlag=viewAllReports&selectedLocCode="+locCode;
...
<hdiits:form name="printAllReports" validate="true" method="POST" action=" ">
	...
	<br/>
	 <table width="45%" border="1" bordercolor="black"  align="center" id="searchTable" rules="">
      <tr>
      <td  align = "center" style="background-color:#F7E7D7 ;color: rgb(202,97,12);font-size: small;font-style: normal;font-weight : bold">DDO CODE</td>
      </tr>
      <tr>
      <td align = "center">
