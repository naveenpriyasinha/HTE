...
function copyPresentPermAdd()
{
	...
	if((presentFlat=='' || presentBuilding=='' || presentTaluka=='' || presentDist=='' || presentPin==''))
	{
		...
		return false;
	} //alert("hi"+document.getElementById("presentAddLandmark").value);
				...
				<fieldset style="width: 95%;" class="tabstyle">
					...
					<table width="100%" align="left">
						...
						<tr>
							...
							<td width="25%" align="left"><input type="text" name="panNo"
						...
						<tr>
							<td width="25%" align="left">Date of Joining(DCPS/NPS
								Applicable Date)</td>
							<td width="25%" align="left"><input type="date" name="doj"
						...
						<table width="100%" align="left">
							<tr>
								...
								<td width="35%" align="left"><input size="10"
									...
									onkeypress="digitFormat(this);dateFormat(this);"
									onblur="chkValidDate(this);validateDOBAndMinorGuardianDtls(this,1);" />
									<img src='images/CalendarImages/ico-calendar.gif' width='20'
							...
							<tr>
								...
								<td width="35%" align="left"><input size="50"
									...
									name="nominee${nomineeCounter}Guardian" 
									<c:if test="${empNomineedetail[4] < 18}"> value=""</c:if>
									<c:if test="${empNomineedetail[4]>=18}"> value="NA" readonly="readonly"</c:if>
							...
							<tr>
								...
								<td width="35%" align="left"><input size="50"
									...
									name="nominee${nomineeCounter}Address" value="NA"
					...
					<table class="table table-bordered">
						<tbody>
							<tr>
								...
								<td width="25%" align="left"><input type="text"
									name="bankAcntNo" id="bankac_number" value="${empDetail[29]}"
							...
							<tr>
								...
								<td width="25%" align="left"><input type="text"
									name="IfscCode" id="ifsccode" value="BKID0000642"
					...
					<table class="table table-bordered">
						<tbody>
							...
							<c:if test="${PhotoFlag==0}">
								<tr>
									<td colspan="2" class="error">Photo or signature is not
										found in our system. So, Kindly upload your photo and
										signature from employee change details.</td>
								</tr>
