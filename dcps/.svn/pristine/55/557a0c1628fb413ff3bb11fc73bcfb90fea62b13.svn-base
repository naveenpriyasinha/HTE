...
<body>
	...
	<div dojoType="dojo.data.ItemFileReadStore" jsId="continentStore"
		url="transfertree.jsp?<%=menuName%>" style="overflow:scrolling;"></div>
...
var fetchURL = continentStore.getValue(item, "name");
   ...
   {
    showProgressbar();
    window.frames['decisiontable'].location='./hrms.htm?actionFlag=decisiontable&nodeid='+fetchURL;
    }
    }
</script>	
</div>
