...
<hdiits:hidden name="fileId" default="${resValue.fileId}"/>
	<div id="tabmenu">
		<ul id="maintab" class="shadetabs">
		           		<li class="selected"><a href="#" rel="tcontent1">Send Draft as Correspondence</a></li>
		</ul>
	</div>
	...
	<div class="tabcontentstyle">
		...
		<display:table list="${resValue.draftLst}" pagesize="12" requestURI="" id="row"  defaultsort="1" style="width:100%">
			...
			<display:column  titleKey="WF.View" headerClass="datatableheader" sortable="true"><a style="cursor:hand;"   href="javascript:openDocument('${row.attchUrl}');"><font color="blue">View</font></a></display:column>
	...
	<script type="text/javascript"> 
		...
		function sendDraftAsCorr(){
			...
			document.forms[0].action="${contextPath}/hdiits.htm?actionFlag=fms_draftsAsCorr";
