	...
	<table width="100%" border='0'>
		...
		<tr>
			...
			<td width="35%" >
			 ...
			 <td>
				<fmt:message key="CMN.POSTSTATUS" bundle="${dcpsLables}" >
			</fmt:message></td>
		<%-- 	<td width="35%" >
				<input type="text" id="txtNewUserName"  name="txtNewUserName" onblur="MinUserNameLength(this);" value="${resValue.ddoCode}"/>
			</td>  --%>
					...
					<td width="20%" align="left">
								<select name="postStatus"
									id="postStatus" style="width: 65%" onChange="" ${varDisabled} disabled="disabled" >
									<option value="${resValue.postStatus}" selected="selected"><c:out value="${resValue.postStatusValue}"></c:out></option>
								</select>
					</td>
		...
		<tr>
			<td  style="display: none;">
				<fmt:message key="CMN.Status" bundle="${dcpsLables}" />
			</td>
			<td width="35%" style="display: none;">
