...
<c:set var="RequestId" value="${resValue.Pkvalue}"> </c:set>
<html>
...
<div id="tabmenu">
	...
	<tr align="centre">
<hdiits:td align="centre"><hr align="center" ><hdiits:caption captionid="Pf.RequestId" bundle="${PayLab}"  captionLang="single"/><c:out value="${RequestId}" default=""></c:out>) </hdiits:td>
...
<hdiits:td>	
	...
	<tr>
	 ...
	 <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<hdiits:button name="ok" type="button" captionid="Pay.Close"  onclick="showEmpName()" bundle="${PayLab}"/><hr align="center" ><td>
	</tr>
