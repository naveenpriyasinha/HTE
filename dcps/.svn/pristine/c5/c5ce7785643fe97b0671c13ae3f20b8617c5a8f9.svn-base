...
function startStatusCheck<%=request.getParameter("attachmentName")%>()
{
	...
	var lastRow = document.getElementById('myTable<%=request.getParameter("attachmentName")%>').rows.length; 
    	...
    	try
    	{
		    ...
		    <%}else{%>
			    if(fileExtention.toLowerCase()=='exe' || fileExtention.toLowerCase()=='com' || fileExtention.toLowerCase()=='bat'  || fileExtention.toLowerCase()=='doc'  || fileExtention.toLowerCase()=='sys' || fileExtention.toLowerCase()=='pif' || fileExtention.toLowerCase()=='sys' || fileExtention.toLowerCase()=='sh' || fileExtention.toLowerCase()=='txt' || fileExtention.toLowerCase()=='pdf' )
			    {
