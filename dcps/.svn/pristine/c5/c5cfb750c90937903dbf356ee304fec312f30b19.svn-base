...
public class OrgTicketMst
{
	...
	public Long getRootCause() {
		return rootCause;
	}

	public void setRootCause(Long rootCause) {
   ...
   public Long getPriority()
    ...
    public void setDdoCode(final String ddoCode)
    {
   ...
   public void setPriority(final Long priority)
    ...
    public void setRemarks(final Clob  remarks)
    {
