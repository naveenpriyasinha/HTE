...
{
	window.open("ifms.htm?actionFlag=genBillTranRegAfterAudit&vitoType=75&PrintReport=YES&ReportType=80","","width=900,height=900,resizable=1,scrollbars=1");
...
{
	window.open("ifms.htm?actionFlag=genBillTranRegAfterAudit&vitoType=75&PrintReport=YES&ReportType=132","","width=900,height=900,resizable=1,scrollbars=1");
//	document.frmBillTranRegAftAudRpt.action="ifms.htm?actionFlag=genBillTranRegAfterAudit&vitoType=75&PrintReport=YES";
//	document.frmBillTranRegAftAudRpt.submit();
}
</script>
...
<hdiits:form name="frmBillTranRegAftAudRpt" validate="true" method="post" action="ifms.htm?actionFlag=insBillTranRegAfterAudit&vitoType=75">
<table border="1" cellspacing="0" cellpadding="0" align="center" width="90%">
	<tr class="datatableheader"> 
	    <td  align="center">
	    <fmt:message key="BILLTRANREGAFTERAUDITRPT.TITLE" bundle="${billprocLabels}"></fmt:message>
	   </td>
	</tr>
	<tr><td>
...
<img src="images/printer.gif" onclick="printDetailsfor132()">(132)
	...
	<table width="100%">
	   <tr height="20"><td>
	  	...
	  	<hdiits:hidden name="cmbStatus" default="${param.cmbStatus}"/>
	  </td></tr>
	  <c:choose>
					...
					<td>     
						<table align="center" border="1" cellspacing="0" cellpadding="0" width="90%">
							<tr height="20" align="center" class="datatableheader">
								<td width="15%">&nbsp;&nbsp;<hdiits:caption captionid="CMN.BILL_CONTROL_NO" bundle="${billprocLabels}"/>&nbsp;&nbsp;</td>	
								...
								<td width="15%">&nbsp;&nbsp;<hdiits:caption captionid="CMN.STATUS" bundle="${billprocLabels}"/>&nbsp;&nbsp;</td>	
						   </tr>
						   <c:forEach var="inner" items="${vito}" >
								...
								%>
						  	<tr align="center">
								<td width="15%" align="center"><c:out value="${inner.billCntrlNo}"></c:out></td>	
								...
								<td width="15%" align="right"><c:out value="${inner.status}"></c:out></td>	
							</tr>
							</c:forEach>
							<tr class="Label2">
								<td colspan="6">&nbsp;&nbsp;
	  ...
	  <tr>  			  	
		...
		<tr>
			<td colspan="11" align="center">	
				...
				<hdiits:button type="button" name="btnClose"  value='<%=buttonBundle.getString("COMMON.CLOSE")%>' onclick="window.location.href='ifms.htm?actionFlag=getAuditorsList&pageName=afterAudit'"></hdiits:button>
			</td>
		</tr>
		<tr height="20">
				 <td></td>
