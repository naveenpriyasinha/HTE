...
<script type="text/javascript" src="script/hrms/training/SelectedEmplistEdit.js"></script>
...
<hdiits:form name="findSelectedEmp" validate="true" method="post" action="./hdiits.htm?actionFlag=SelectedEmplistEdit">
...
<div id="tcontent1" class="tabcontentForPopup" tabno="0" title='<fmt:message bundle="${searchLabels}" key="TR.SEARCH_TRAINING"/>'>
 <table class="datatable" headerClass="datatableheader" border="0" width="100%" height="30%" style="tabtable">
	...
	<tr>
		...
		<td class="fieldLabel" width="25%"><hdiits:text name="txtTrainingType" maxlength="20" id="trainingType" default="%" onkeypress="return validateText(event, false)"/></td>	
