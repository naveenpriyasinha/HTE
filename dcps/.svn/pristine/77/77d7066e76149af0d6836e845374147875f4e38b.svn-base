...
function approve(srNo,ddoCode,ddoName,userID)
{
	...
	//ADDED BY ROSHAN
	var url = "ifms.htm?actionFlag=aprvDDOHistoryForMdp&srNo="+srNo+"&ddoCode="+ddoCode+"&ddoName="+ddoName+"&userID="+userID;
...
function reject(srNo,ddoCode,ddoName,userID)
{
	...
	var url = "ifms.htm?actionFlag=rjctDDOHistoryForMdp&srNo="+srNo+"&ddoCode"+ddoCode+"&ddoName"+ddoName+"&userID"+userID;
	document.approveDDOHistory.action = url ;
	document.approveDDOHistory.submit();
}
</script>
