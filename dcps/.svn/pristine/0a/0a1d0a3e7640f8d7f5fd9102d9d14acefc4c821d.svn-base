...
{	
	...
	if(radioValue=="Stop2ndLC"){
		window.returnValue = "Stop2ndLC";
	}
	else if(radioValue=="Want2ndLC"){
		window.returnValue = "Want2ndLC";
	}
...
<table width="100%">
	<tr>
		<td width="1%"><input type="radio" name="rdoDisburse" id="rdoWant2ndDisburse" value="Want2ndLC" checked="checked"/></td>
		<td width="99%"><fmt:message key="CMN.OPTION1FORPPLC" bundle="${lnaLabels}"></fmt:message></td>
	</tr>
	<tr>
		<td width="1%"><input type="radio" name="rdoDisburse" id="rdoStop2ndDisburse" value="Stop2ndLC"/></td>
		<td width="99%"><fmt:message key="CMN.OPTION5FORPPLC" bundle="${lnaLabels}"></fmt:message></td>
	</tr>
	<tr>			
