...
<hdiits:form name="viewCorrForm" method="POST" action="./hdiits.htm" encType="multipart/form-data" validate="true">
...
{		
		...
		document.forms[0].method='post';      
      	//document.forms[0].action='${contextPath}/hdiits.htm?actionFlag=reportService&reportCode=6000009&action=generateReport&PostId='+Post+'&Section='+section+'&docName='+Subject+'&Tricode='+letterno+'&CorrDesc='+Description;
      	document.forms[0].action='${contextPath}/hdiits.htm?actionFlag=reportService&reportCode=6000052&action=generateReport&PostId='+Post+'&Section='+section+'&docName='+Subject+'&Tricode='+letterno+'&CorrDesc='+Description;      	
