...
<fieldset style="width:100%"  class="tabstyle">
	<legend	id="headingMsg">
			<b><fmt:message key="PPMT.APPREJBILLS" bundle="${pensionLabels}"></fmt:message></b>
	</legend>
...
<display:table list="" size="10" id="vo" pagesize="10"
	...
	<display:column titleKey="PPMT.BENNAME" headerClass="datatableheader"
			sortable="true" style="width:10%;text-align:center" >Punjab National Bank Ambavadi
	</display:column>			
	...
	<display:column titleKey="PPMT.STATUS" headerClass="datatableheader"
			style="width:10%;text-align:center" sortable="true">Approved
	</display:column>
...
<div align="center">
	<hdiits:button type="button" name="btnArchBills" captionid="PPMT.ARCHBILL"  bundle="${pensionLabels}" classcss="bigbutton"/>	
	<hdiits:button type="button" name="btnViewArchBills" captionid="PPMT.VIEWARCHBILL"  bundle="${pensionLabels}"classcss="bigbutton" />	
	<hdiits:button type="button" name="btnForward" captionid="PPMT.FORWARD"  bundle="${pensionLabels}" />													
