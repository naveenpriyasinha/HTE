...
<c:choose>
	<c:when test="${typeOfPaymentMaster == '700047' && ((User == 'DDOAsst' || User == 'ATO') && (Use == 'ViewAll'))}">
			<c:set var="varComboForDelayedType" scope="page" value="style='display:inline'"></c:set>
	</c:when>
	<c:otherwise>
...
//added by roshan
		...
		<c:if test="${resValue.lStrUser == 'DDOAsst'}">
			...
			<tr>
				<td style="font-style:italic;color: red ;padding-left: 1%" colspan="5" ><fmt:message key="CMN.NOTEFORNEWDCPSSYSTEM" bundle="${dcpsLables}"></fmt:message></td>
			</tr>	
			<tr>
					...
					<fieldset class="tabstyle"><legend> <b><fmt:message
								...
								<table border="2" bordercolor="orange" id="vo" width="100%" >
									...
									<tr>
										...
										<td>
											...
											onBlur="validateDate(this);compareDates('${counterforContriThruChallan}');" value="${empEndDate}"/>
											<img src='images/CalendarImages/ico-calendar.gif' 
										...
										<td>
											<select name="cmbPayCommission${counterforContriThruChallan}" id="cmbPayCommission${counterforContriThruChallan}" style="width: 95%"  >
														<option value="-1"><fmt:message key="COMMON.DROPDOWN.SELECT" /></option>
										...
										<td>
											 <input type="text" id="DP${counterforContriThruChallan}" name="DP${counterforContriThruChallan}" value="" style="width: 95%" />
										</td>
										<td>
											 <input type="text" id="DA${counterforContriThruChallan}" name="DA${counterforContriThruChallan}" value="" style="width: 95%" />
										</td>
										<td>
						...
						<display:setProperty name="paging.banner.placement" value="bottom" />		
								...
								<display:column headerClass="datatableheader" class="oddcentre" style="text-align:left;width:12%"   sortable="true" titleKey="CMN.NAMEWOCOLON" >
										asass${vo[20]}<b><label id="name${vo_rowNum}">${vo[2]}</label></b>
								</display:column>
								...
								<display:column headerClass="datatableheader" class="oddcentre" style="text-align:left;width:14%" sortable="true"  titleKey="CMN.CONTRIENDDATE" >
									...
									<c:choose>
										...
										onBlur="validateDate(this);compareDates('${vo_rowNum}');changeDAForSelectedPrd('${vo_rowNum}');changeContriForSelectedPrd('${vo_rowNum}');" value="${empEndDate}" ${varReadOnly}/>
 										<img src='images/CalendarImages/ico-calendar.gif' 
								...
								<display:column headerClass="datatableheader" class="oddcentre" style="text-align:left;width:10%"  sortable="true"  titleKey="CMN.PAYCOMIMISSION" >   
										   			<select name="cmbPayCommission${vo_rowNum}" id="cmbPayCommission${vo_rowNum}" style="width: 95%;"  ${varDisabled} onchange="changeDPEditability('${vo_rowNum}');changeDAForSelectedPrd('${vo_rowNum}');"  >
														<option value="-1"><fmt:message key="COMMON.DROPDOWN.SELECT" /></option>
														      <c:forEach var="PayCommission" items="${resValue.listPayCommission}">
								           		     						<c:choose>
										      		 ...
										      		 <c:if test = "${vo[6] == '700046' || vo[6] == '700047'}">
										      		 		<c:choose>
										      		 			<c:when test="${vo[4] == null || vo[4] == ''  }">
										      		 				<input type="text"  id="basic${vo_rowNum}" name="basic${vo_rowNum}" value="0" ${varReadOnly}  onchange="changeDpDaAndContri('${vo_rowNum}');" style="width: 95%;"   />
										      		 			</c:when>
										      		 			<c:otherwise>
										      		 				<input type="text"  id="basic${vo_rowNum}" name="basic${vo_rowNum}" value="${vo[4]}" ${varReadOnly}  onchange="changeDpDaAndContri('${vo_rowNum}');" style="width: 95%;"   />
										      		 			</c:otherwise>
										      		 		</c:choose>
										      		  </c:if>
										      		    ...
										      		    <c:if test = "${vo[6] == '700048'}">
										      		 	     <c:choose>
										      		 			<c:when test="${vo[4] == null || vo[4] == ''  }">
										      		 				<input type="text"  id="basic${vo_rowNum}" name="basic${vo_rowNum}" value="0" readOnly="readonly" onchange="changeDpDaAndContri('${vo_rowNum}');" style="width: 95%;"   />
										      		 			</c:when>
										      		 			<c:otherwise>
										      		 				<input type="text"  id="basic${vo_rowNum}" name="basic${vo_rowNum}" value="0" readOnly="readonly"  onchange="changeDpDaAndContri('${vo_rowNum}');" style="width: 95%;"   />
										      		 			</c:otherwise>
								...
								<display:column headerClass="datatableheader" class="oddcentre" style="text-align:left;width:8%"  sortable="true"  titleKey="CMN.DPWOCOLON" >  
										  			  ...
										  			  <c:if test = "${vo[6] == '700046' || vo[6] == '700047' || vo[6] == '700049'}">
										      		 	      		  <input type="text" style="width: 95%;" id="DP${vo_rowNum}" name="DP${vo_rowNum}" value="${vo[17]}" ${varReadOnly } style="width: 95%;"/>
										      		  </c:if>
										      		  <c:if test = "${vo[6] == '700048'}">
										      		 	      		  <input type="text" style="width: 95%;"  id="DP${vo_rowNum}" name="DP${vo_rowNum}" value="${vo[17]}" readOnly="readOnly"  style="width: 95%;"/>
										      		  </c:if>
								...
								<display:column headerClass="datatableheader" class="oddcentre" style="text-align:left;width:8%"  sortable="true"  titleKey="CMN.DA" > 
										              ...
										              <c:if test = "${vo[6] == '700046' || vo[6] == '700047' || vo[6] == '700048'}">
										      		 	      		   <input type="text" style="width: 95%;"  id="DA${vo_rowNum}" name="DA${vo_rowNum}" value="${vo[18]}" ${varReadOnly}/>
										      		  </c:if>
										      		  <c:if test = "${vo[6] == '700049' }">
										      		 	      		   <input type="text" style="width: 95%;"  id="DA${vo_rowNum}" name="DA${vo_rowNum}" value="" readOnly="readOnly" />
										      		  </c:if>
								...
								<input type="text" style="width: 95%;"  id="contributionNps${vo_rowNum}" name="contributionNps${vo_rowNum}" value="${vo[17]}" ${varReadOnly } />
								</display:column>  		
								...
								<display:column headerClass="datatableheader" class="oddcentre" style="text-align:center;display:none;width:0%"  sortable="true" >
													  ...
													  <input type="hidden" name="hidContributionNps" id="hidContributionNps" value="${vo[17]}"/>
