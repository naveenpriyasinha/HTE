...
<hdiits:form name="DCPSForm" id="DCPSForm" encType="multipart/form-data"
	...
	<ul id="maintab" >
			...
			<li class="selected" id="personalDtls"><a href="#" rel="tcontent1"><fmt:message
		key="CMN.EMPDETAILS" bundle="${dcpsLables}"></fmt:message> </a></li>
			<li id="officeDtls" ><a href="#" rel="tcontent2" onfocus="checkMinDtls();"><fmt:message
		key="CMN.OFFDETAILS" bundle="${dcpsLables}"></fmt:message></a></li>
			<li id="otherDtls" ><a href="#" rel="tcontent3" onfocus="checkMinDtls();"><fmt:message
		key="CMN.BANKDCPSGPFDETAILS" bundle="${dcpsLables}"></fmt:message></a></li>
		<li id="otherDtls" ><a href="#" rel="tcontent4" onfocus="checkMinDtls();"><fmt:message
		key="CMN.GISDETAILS" bundle="${dcpsLables}"></fmt:message></a></li>
			<li id="nomineeDtls" ><a href="#" rel="tcontent5" onfocus="checkMinDtls();"><fmt:message
		key="CMN.NOMINEEDETAILS" bundle="${dcpsLables}"></fmt:message></a></li>
			<li id="photoAndSignDtls" ><a href="#" rel="tcontent6" onfocus="checkMinDtls();"><fmt:message
	...
	<div class="tabcontentstyle"><!-- Personal Details Page -->
	...
	<input type="hidden" id="hidSearchFromDDO" value="${resValue.lStrFromSearch}"/>
	...
	<c:choose>
		...
		<table width="100%">
						...
						<c:choose>
							<c:when test="${resValue.EditForm == 'N'}">
								<tr>
									...
									<td width="80%"><input type="text" id="txtApproverRemarks"
										name="txtApproverRemarks" size="100" value="" /></td>
								</tr>
								<tr><td colspan="2" style="font-style:italic;color:red"><fmt:message key="CMN.FORMFORWARDTOTOFORDCPSMSG" bundle="${dcpsLables}"></fmt:message></td></tr>
							</c:when>
						</c:choose>
					</table>
				</td>
			...
			<tr>
			<td>
			<table align="right"  cellspacing="4" cellpadding="4" width="30%"
				border="0">
				<c:choose>
					<c:when test="${resValue.EditForm != 'N'}">
						...
						<c:choose>
							<c:when test="${EMPVO==null}">
								<tr>
									...
									<td><input type="hidden" id="ForwardToPost"
										...
										captionid="BTN.FORWARDTODDO" bundle="${dcpsLables}" style="width:100%"
										onclick="forwardRequestAfterValidation(0);" /></td>
										
									<td style="display:none" ><input type="hidden" id="ApproveToPost"
										name="ApproveToPost" value="${ATOUserList[0]}" /> <hdiits:button
										name="BTN.APPROVE" id="btnForward" type="button"
							...
							<c:otherwise>
								<tr>
									...
									<td><input type="hidden" id="ForwardToPost"
										name="ForwardToPost" value="${UserList[0]}" /> <hdiits:button
										name="BTN.FORWARDTODDO" id="btnForwardForUpdateTotally" type="button"
										captionid="BTN.FORWARDTODDO" bundle="${dcpsLables}" style="width:100%"
					...
					<c:otherwise>
						<tr>
							...
							<td align="center" id="updatebtn"><hdiits:button
								name="btnReject"
								id="btnReject" type="button"
								captionid="BTN.REJECT" bundle="${dcpsLables}"
								onclick="rejectRequest('${EMPVO.dcpsEmpId}');" /></td>
								
								<input type="hidden" id="hidDcpsOrGpf" name="hidDcpsOrGpf" value="${EMPVO.dcpsOrGpf}" />
								...
								<c:choose>
									...
									<input type="hidden" id="ForwardToPost"
										...
										<td>
											<hdiits:button
											name="BTN.APPROVE" id="btnApproveForUpdateTotally" type="button"
											captionid="BTN.APPROVE" bundle="${dcpsLables}"
										...
										<td>
											<hdiits:button
											name="BTN.FORWARD" id="btnForwardForUpdateTotally" type="button"  readonly = "true"
											captionid="BTN.FORWARDTOTOONLY" bundle="${dcpsLables}"
											onclick="" />
										</td>
									...
									<c:otherwise>
										...
										<td>
											<hdiits:button
											name="BTN.APPROVE" id="btnApproveForUpdateTotally" type="button" readonly = "true"
											captionid="BTN.APPROVE" bundle="${dcpsLables}"
											onclick="" />
										</td>
										...
										<td>
											<input type="hidden" id="ForwardToPost"
											name="ForwardToPost" value="${UserList[0]}" /> <hdiits:button
											name="BTN.FORWARD" id="btnForwardForUpdateTotally" type="button"
											captionid="BTN.FORWARDTOTOONLY" bundle="${dcpsLables}"  style="width:100%"
											onclick="ForwardRequestDDO('${EMPVO.dcpsEmpId}');" />
										</td>
									</c:otherwise>
								</c:choose>
									...
									<td>
										<input type="hidden" id="formPrintedOrNot" value="NO"/>
										<hdiits:button name="btnPrintForm1" id="btnPrintForm1" type="button"  captionid="BTN.PRINTFORM1" bundle="${dcpsLables}" onclick="printForm1ByDDO('${EMPVO.dcpsEmpId}');"/>
									</td>
						</tr>
					</c:otherwise>
				</c:choose>
