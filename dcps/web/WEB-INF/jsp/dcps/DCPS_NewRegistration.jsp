...
<table width="100%" align="center" cellpadding="0" cellspacing="0">
	<tr>
		<td width="20%" align="left"><fmt:message key="CMN.FIRSTNAME" bundle="${dcpsLables}"></fmt:message></td>
		<td width="20%" align="left">
			<input type="text" id="txtFirstName" style="text-transform: uppercase" size="30"  name="txtFirstName" value="" />
		</td>
		<td width="10%" align="left"><fmt:message key="CMN.MIDDLENAME" bundle="${dcpsLables}"></fmt:message></td>
		<td width="20%" align="left">
			<input type="text" id="txtMiddleName" style="text-transform: uppercase" size="30"  name="txtMiddleName" value="" />
		</td>
		<td width="10%" align="left"><fmt:message key="CMN.LASTNAME" bundle="${dcpsLables}"></fmt:message></td>
		<td width="30%" align="left">
			<input type="text" id="txtLastName" style="text-transform: uppercase" size="30"  name="txtLastName" value="" />
		</td>
	</tr>
	<tr>
		<td width="20%" align="left"><fmt:message key="CMN.MALE" bundle="${dcpsLables}"></fmt:message>
			<input type="radio" id="radioGender" name="radioGender" value="Male" checked="checked"/>
		</td>
		<td width="20%" align="left"><fmt:message key="CMN.FEMALE" bundle="${dcpsLables}"></fmt:message>
			<input type="radio" id="radioGender" name="radioGender" value="Female"/>
		</td>
		<td width="10%" align="left"><fmt:message key="CMN.DOB" bundle="${dcpsLables}"></fmt:message></td>
		<td width="" align="left">
	...
	<tr>
		<td width="20%" align="left"><fmt:message key="CMN.DOJ" bundle="${dcpsLables}"></fmt:message></td>
		<td width="20%" align="left">
...
<fieldset class="tabstyle">
<legend>
	<b><fmt:message key="CMN.CADREINPARENTDEPT" bundle="${dcpsLables}"></fmt:message></b>
</legend>
<table width="100%" align="center" cellpadding="0" cellspacing="0">
	<tr>
		...
		<td width="20%" align="left"><fmt:message key="CMN.CHANGEPARENTDEPT" bundle="${dcpsLables}"></fmt:message></td>
		<td width="30%" align="left">
	...
	<tr>
		...
		<td width="20%" align="left"><fmt:message key="CMN.GROUP" bundle="${dcpsLables}"></fmt:message></td>
		<td width="30%" align="left">
...
<fieldset class="tabstyle">
	...
	<tr>
		...
		<td width="20%" align="left"><fmt:message key="CMN.PAYSCALE" bundle="${dcpsLables}"></fmt:message></td>
		<td width="30%" align="left">
			<input type="text" id="txtPayScale"  size="30"  name="txtPayScale" value="" />
		</td>
	</tr>
	<tr>
		<td width="20%" align="left"><fmt:message key="CMN.RESIDENTIALADDRESS" bundle="${dcpsLables}"></fmt:message></td>
		<td width="30%" align="left">
			<input type="text" id="txtResidentialAddress"  size="30"  name="txtResidentialAddress" value="" />
		</td>
		<td width="20%" align="left"><fmt:message key="CMN.OFFICECONTACTNO" bundle="${dcpsLables}"></fmt:message></td>
		<td width="30%" align="left">
			<input type="text" id="txtOfficeContactNo"  size="30"  name="txtOfficeContactNo" value="" />
		</td>
	</tr>
	<tr>
		<td width="20%" align="left"><fmt:message key="CMN.ADDRESS2" bundle="${dcpsLables}"></fmt:message></td>
		<td width="30%" align="left">
			<input type="text" id="txtAddress2"  size="30"  name="txtAddress2" value="" />
		</td>
		<td width="20%" align="left"><fmt:message key="CMN.CELLNO" bundle="${dcpsLables}"></fmt:message></td>
		<td width="30%" align="left">
			<input type="text" id="txtCellNo"  size="30"  name="txtCellNo" value="" />
		</td>
	</tr>
	<tr>
		<td width="20%" align="left"><fmt:message key="CMN.CONTACTTELNO" bundle="${dcpsLables}"></fmt:message></td>
		<td width="30%" align="left">
...
<fieldset class="tabstyle">
<legend>
	<b><fmt:message key="CMN.NOMINEEDETAILS" bundle="${dcpsLables}"></fmt:message></b>
</legend>
<table width="100%" align="center" cellpadding="0" cellspacing="0">
	<tr>
		<td width="10%" align="left"><fmt:message key="CMN.NOMINEESRNO" bundle="${dcpsLables}"></fmt:message></td>
		<td width="20%" align="left">
			<input type="text" id="txtNomineeSerialNo"  size="30"  name="txtNomineeSerialNo" value="" />
		</td>
		<td width="10%" align="left"><fmt:message key="CMN.NAME" bundle="${dcpsLables}"></fmt:message></td>
		<td width="" align="left">
	...
	<tr>
		<td width="20%" align="left"><fmt:message key="CMN.ADDRESS1" bundle="${dcpsLables}"></fmt:message></td>
		<td width="20%" align="left">
	...
	<tr>
		<td width="20%" align="left"><fmt:message key="CMN.DOB" bundle="${dcpsLables}"></fmt:message></td>
		<td width="30%" align="left">
			<input type="hidden" name="currDate" id="currDate" value="${resValue.lDtCurDate}"/>
		...
		<td width="10%" align="left"><fmt:message key="CMN.PERCENTSHARE" bundle="${dcpsLables}"></fmt:message></td>
		<td width="40%" align="left">
			<input type="text" id="txtPercentShare"  size="30"  name="txtPercentShare" value="" />
		</td>
	</tr>
	<tr>
		<td width="20%" align="left"><fmt:message key="CMN.RELATIONSHIP" bundle="${dcpsLables}"></fmt:message></td>
		<td width="30%" align="left">
...
<table width="100%" align="center" height="10%" cellpadding="0" cellspacing="0">
	...
	<tr>
		<td width="100%" align="center">
			<hdiits:button name="btnSave" id="btnSave" type="button"  captionid="BTN.SAVE" bundle="${dcpsLables}" onclick=""/>
			<hdiits:button name="btnAdd" id="btnAdd" type="button" captionid="BTN.ADD" bundle="${dcpsLables}"  onclick="addRowToTableForNomineeDtls(createArrOfColsForNomineeDtls(),createArrOfHeadersForNomineeDtls(),'displayTableForNomineeDtls')" />
			<hdiits:button name="btnView" id="btnView" type="button"  captionid="BTN.VIEW" bundle="${dcpsLables}" onclick=""/>
		</td>
	</tr>	
</table>
