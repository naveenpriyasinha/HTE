...
<hdiits:form name="scheme" validate="true" method="POST" action="hrms.htm?actionFlag=getDepartmentList&edit=N" encType="multipart/form-data">

<div id="tabmenu">
	<ul id="maintab" class="shadetabs">
		<li class="selected"><a href="#" rel="tcontent1"><b><fmt:message key="SH.SchemeEntry" bundle="${commonLables}"/></b></a></li>
	</ul>
</div>
...
<div class="halftabcontentstyle">
	...
	<TR>
    	...
    	<TD	width ="25%"><hdiits:select style="width:90%"  name="cmbDept" size="1" sort="false" caption="Department" captionid="Dept" validation="sel.isrequired" mandatory="true" onchange="GetDemandNo();" >
	    <hdiits:option value="-1">---------------------------Select----------------------------</hdiits:option>
	  			<c:forEach items="${deptList}" var="dept">
	    		   <hdiits:option value="${dept.locationCode}" selected="true" >${dept.locName} </hdiits:option>
	    		</c:forEach>
	   	</hdiits:select>
	   </TD>
	</TR>
...
<tr>
	    ...
	    <hdiits:number style="width:87%"  mandatory="true" id = "schemeCode" name="schemeCode" caption="schemeCode" validation="txt.isrequired"  size="10"	 maxlength="50" />
	    </td>
		
    	<TD align="left" width = "15%">
		<b><fmt:message key="BHM.SCHEMENAME" bundle="${commonLables}"/></b></TD>
		<TD width ="25%">
	    <hdiits:text style="width:87%" mandatory="true" id = "schemeName" name="schemeName" caption="schemeName" validation="txt.isrequired"  size="20"	 maxlength="200" />
	    </td>
</tr>
...
<tr>		
	...
	<td align="left" width ="25%">
	<hdiits:select  style="width:90%" name="cmbDemand" id="cmbDemand" size="1" mandatory="true" caption="Demand No" captionid="DmdNo" validation="sel.isrequired" sort="false" onchange="GetMjrHeadNo();" >
	<hdiits:option value="-1">---------------------------Select----------------------------</hdiits:option>
	</hdiits:select>
	</td>
...
<tr></tr><tr></tr><tr></tr><tr></tr>
	...
	<td width ="25%">
	 <hdiits:select  style="width:90%" name="cmbMnrHead" id="cmbMnrHead" size="1" sort="false"  caption="Minor Head" captionid="MnrHeadNo"	mandatory="true" validation="sel.isrequired" onchange="GetSubHeads2();">
	   <hdiits:option value="-1">---------------------------Select----------------------------</hdiits:option>
	 </hdiits:select>
	 </td>
	</tr>
	...
	<tr>
	 ...
	 <B>Scheme Type</B>
  	...
  	<td>
  	<b><hdiits:radio name="SchmeType" id="Charged" readonly="${readOnly}"  value="Charged"   captionid="SH.CHARGED" bundle="${commonLables}" default="" /></b>
  	
    <B><hdiits:radio name="SchmeType" id="Voted"  readonly="${readOnly}" value="Voted"   captionid="SH.VOTED" bundle="${commonLables}" default=""  /></td>
    </td>
  	...
  	<td>
  	<b><hdiits:radio name="IsPlane" id="ece" readonly="${readOnly}"  value="Plan"   captionid="SH.PLAN" bundle="${commonLables}" default="" /></b>
  	
    <b><hdiits:radio name="IsPlane" id="Non-Plan"  readonly="${readOnly}" value="Non-Plan"   captionid="SH.NONPLAN"  bundle="${commonLables}" default=""  /></b>
    </td>
...
<tr></tr><tr></tr><tr></tr><tr></tr>
	<tr>
		<td  align="left" width="16%"  ><b><fmt:message key="SH.HEADCHARGABLE" bundle="${commonLables}"/><b></td> 
			<td align="left" width="34%" ><hdiits:text style="width:250px"  id = "headChargable" name="headChargable" caption="charge."  maxlength="250" size="250" mandatory="true" validation="txt.isrequired" readonly="true"/></td>
	</tr>
