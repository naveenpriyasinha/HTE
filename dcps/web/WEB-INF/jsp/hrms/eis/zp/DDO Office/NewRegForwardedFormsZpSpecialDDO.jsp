...
function filterByDDOCode(){
	...
	var url;
		...
		url="ifms.htm?actionFlag=viewFormsForwardedByAsstZpFinalDDO&User=FinalDDO&Use=Forward&reptddoCode="+reptddoCode+"&asstddoCode="+asstddoCode;
...
<fieldset class="tabstyle"><legend> <b><fmt:message
	...
	<display:table list="${empList}" id="vo" requestURI="" export="" style="width:50%"
		...
		<display:column style="text-align: left;"  class="oddcentre"
		 			titleKey="CMN.FINALDDOCODE" sortable="true"
					 headerClass="datatableheader"   ><c:out value="${vo[9]}"/>
		</display:column>	
	</display:table>
</fieldset>
</div>
