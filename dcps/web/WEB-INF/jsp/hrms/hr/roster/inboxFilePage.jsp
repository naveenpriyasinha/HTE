...
<script type="text/javascript" src="script/hrms/hr/rosterScript/inboxFilePage.js">
</script>
...
function SearchEmp(form){
	...
	var href='<%=request.getRequestURL() %>'+'?actionFlag=getAllSearchEmp';
...
<hdiits:form name="Roster" validate="true" method="POST" action="" >
	...
	<div id="tooltip_main${rlist.serialNo}" class="bubble_tooltip">
			...
			<tr>
				...
				<td >&nbsp;<label id="finalsebc${rlist.serialNo}"></label> </td>	
				<td >&nbsp;<label id="finalph${rlist.serialNo}"></label></td>
				...
				<td >&nbsp;<label id="sebc${rlist.serialNo}"></label><hdiits:hidden name="hidsebc${rlist.serialNo}" id="hidsebc${rlist.serialNo}" default="0" />  </td>	
				<td >&nbsp;<label id="ph${rlist.serialNo}"></label><hdiits:hidden name="hidph${rlist.serialNo}" id="hidph${rlist.serialNo}" default="0" />  </td>
