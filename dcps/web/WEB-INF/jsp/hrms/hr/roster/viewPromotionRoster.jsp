...
<script type="text/javascript" src="script/hrms/hr/rosterScript/viewPromRoster.js">
</script>
...
<hdiits:form name="Roster" validate="true" method="POST"
	...
	<table id="rostertb" style="width: 100%;height: 50%" border="1">
			...
			<td valign="bottom" colspan="2" rowspan="1" style="width: 149px"><hdiits:caption	captionid="Hr_resservedseat" bundle="${caption}"/></td>
		...
		<c:forEach var="previousList" items="${previousList}">
			...
			<tr bgcolor="WHITE">
				<td >&nbsp;<label id="finalsc${previousList.serialNo}"></label> </td>		
				<td >&nbsp;<label id="finalst${previousList.serialNo}" ></label></td>	
				...
				<td rowspan="1" style="width: 15px" >&nbsp;<label id="sc${previousList.serialNo}"></label> <hdiits:hidden
					name="hidsc${previousList.serialNo}"
					id="hidsc${previousList.serialNo}" default="0" /></td>
				<td rowspan="1" style="width: 25px" >&nbsp; <label id="st${previousList.serialNo}"></label><hdiits:hidden
