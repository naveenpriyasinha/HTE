...
<script type="text/javascript" src="script/hrms/hr/rosterScript/promInboxEditPage.js">
</script>
<script type="text/javascript"
...
<hdiits:form name="Roster" validate="true" method="POST"
	action="./hdiits.htm?actionFlag=submitAllocationDlts">
	<div id="tabmenu">
	...
	<table border="3" bordercolor="black" class="datatable" id="rostertb"	style="width: 100% ;height: 100%">
		...
		<c:forEach var="rlist" items="${resValue.rosterlist}">
			...
			<tr>
				...
				<td nowrap="nowrap"><hdiits:text name="empName${rlist.serialNo}" readonly="true"  id="empName${rlist.serialNo}" /> <img  src="images/search_icon.gif" name="Search${rlist.serialNo}"  id="Search${rlist.serialNo}" tooltip="Click Here To Search Employee" onclick="SearchEmp(this)" style="display:none" />
	...
	<c:forEach var="finalList" items="${finalList}"> 
		...
		<script>
			...
			var tmpDate="${finalList.joinDate}";
			var joindt=new Date();
			joindt="${finalList.joinDate}";
			var dateNtime=getDateAndTimeFromDateObj(joindt);
			document.getElementById('lblDoj'+listCnt).value=dateNtime[0];
