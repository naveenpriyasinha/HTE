...
<div id="tabmenu">
	<ul id="maintab" class="shadetabs">
		...
		<hdiits:caption captionid="Allocation.details" bundle="${AllocLab}"></hdiits:caption></b></a></li>
	...
	<tr align="centre">
<hdiits:td align="centre"><hr align="center"  ><font size="4" color="red" ><hdiits:caption captionid="Allocation.success" bundle="${AllocLab}"  /></font> </hdiits:td>
