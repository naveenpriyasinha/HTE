...
//	window.close;
	...
	url = "hrms.htm?actionFlag=getIncrEmpList&billId="+strBillNo+"&month="+strMonth+"&year="+strYear+"&selIncrtype="+strIncrtype;
...
<c:set var="billId" value="${resValue.billId}"/>
<c:set var="monthStr" value="${resValue.monthStr}"/>
<c:set var="yearStr" value="${resValue.yearStr}"/>
<c:set var="incrtype" value="${resValue.incrtype}"/>
...
<script type="text/javascript">
	...
	var strBillNo = '${billId}';
	var strMonth = '${monthStr}';
	var strYear = '${yearStr}';
	var strIncrtype = '${incrtype}';
