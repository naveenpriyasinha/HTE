...
<fmt:setBundle basename="resources.ess.utils.search.search" var="comLable"
	scope="request" />
	<fmt:setBundle basename="resources.hr.gratuityLeaveencashment.commonretirement" var="commonretirement"
	scope="request" />
			...
			<table align="center" >
				...
				<tr>
					...
					<td><hdiits:select name="depId" id="depId" size="1" caption="drop_down"
						onchange="showOfficeName('location','depId','locId');" tabindex="1" sort="false">
				...
				<tr>
					...
					<td><hdiits:select name="dsgnId" size="1" caption="dsgnId"
						mandatory="false" tabindex="3" sort="false">
						<hdiits:option value="0"><fmt:message key="select" bundle="${comLable}" /></hdiits:option>
					...
					<td><hdiits:text name="empName" size="30" tabindex="4" default="${empName}"/></td>
				...
				<tr>
					...
					<td class="fieldLabel" >
						<hdiits:dateTime name="retFromDate" validation="txt.isrequired"  mandatory="true" captionid="retirefromdate" bundle="${comLable}" default="${resultValue.retFromDate}" maxvalue="31/12/9999" tabindex="5"></hdiits:dateTime>
					</td>
					
					<td class="fieldLabel" ><hdiits:caption captionid="to" bundle="${comLable}" ></hdiits:caption></td>
					<td class="fieldLabel" >
						<hdiits:dateTime name="retToDate" validation="txt.isrequired"  mandatory="true" captionid="retiretodate" bundle="${comLable}" default="${resultValue.retToDate}" maxvalue="31/12/9999" tabindex="6"></hdiits:dateTime>
					</td>
				...
				<tr >
					...
					<td class="fieldLabel" >
						<hdiits:select name="retTypecmb" captionid="type" bundle="${comLable}" validation="sel.isrequired" id="retTypecmb" mandatory="true" tabindex="7" >
							<hdiits:option value="Select"><fmt:message bundle="${comLable}" key ="select" /></hdiits:option>
				...
				<tr>
					<td align="center" width="100%" colspan="4"><hdiits:button name="go" captionid="HRMS.search" type="button"
						tabindex="8" onclick="searchGo()" bundle="${commonretirement}"/></td>
				</tr>
		...
		<table align="center">
			...
			<tr align="center">
				<td align="center"><hdiits:button name="Submit" type="button" 
					captionid="HRMS.${submitoptn}" bundle="${commonretirement}" tabindex="11" onclick="submitReq()" /> <hdiits:button
					name="Reset" type="button" captionid="HRMS.reset" bundle="${commonretirement}"  tabindex="12" onclick="resetValues()"/></td>
			</tr>
		</table>
	</div>
