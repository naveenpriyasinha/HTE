...
function submit1()
{
	...
	document.AcrInitiatedByAdmin.action="./hrms.htm?actionFlag=ACRInitiateByAdmin";
...
{
	document.AcrInitiatedByAdmin.method="POST";
	document.AcrInitiatedByAdmin.action="./hdiits.htm?actionFlag=getMenuOnApplicationPage&elementCodeForRoot=300022&viewJspName=hrmsHome&elementId=302322";	
	document.AcrInitiatedByAdmin.submit();
}
</script>
		...
		<table class="tabtable" align="center">
				<tr>
					<td align="center" class="fieldLabel" width="100%">
						...
						<b><hdiits:caption captionid="HR.ACR.ACRInitiatedByAdmin" bundle="${commonLables}"/></b>
...
<hr width="80%" align="center">
		...
		<tr colspan="2">
							<td>
								<hdiits:button captionid="HR.ACR.BtnGotoAdminInit" bundle="${commonLables}" name="AcceptChange" type="button"   onclick="submit1();"/>								
							</td>
							<td>
