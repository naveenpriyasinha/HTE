...
<c:set var="xmlFileName1" value="${resValue.xmlFileName1}" />
<c:set var="TransferVOPromotion" value="${resValue.TransferVOPromotion}" />

<div id="tabmenu">
	<ul id="maintab" class="shadetabs">
		<li class="selected"><a href="#" rel="tcontent1"><hdiits:caption captionid="trn.tranRequest" bundle="${transferLables}"></hdiits:caption>
		 </a></li>
	</ul>
	</div>
...
<hdiits:fieldGroup titleCaptionId="trn.gnlst" bundle="${transferLables}" expandable="true" mandatory="true" > 
	...
	<input type="hidden" id="userId" name="userid">
      ...
      <hdiits:button style="display:none" name="DeleteChecked" type="button" bundle="${transferLables}" captionid="trn.rmv" onclick="delchecked()"/>
...
<c:if test="${not empty TransferVOPromotion}">
	<c:forEach items="${TransferVOPromotion}" var="TransferVO" varStatus="x">
...
var dater='${dor}';
var psthist='${postihistory}';
var trow= document.getElementById('transferEmp').insertRow();
var j=0;				    	 
									    	trow.insertCell(j).innerHTML = '<hdiits:checkbox id="'+userid+'" name="userid" value="'+userid+'"  onclick="checkclick(this)" />';
				   							trow.insertCell(j+1).innerHTML=name;
	   										trow.insertCell(j+2).innerHTML=dsgn;
...
<!-- End  -->
	...
	<table width="100%">
		<tr align="center">
			<td>
			     <hdiits:button name="srcdAdd" type="button" captionid="trn.srchEmp" bundle="${transferLables}" onclick="SearchEmp()" style="display:none"></hdiits:button> 
