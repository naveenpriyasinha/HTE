...
<tr>
	...
	<table id="LeavePersonDetails" width="100%" align="center">
		...
		<tr>
			...
			<td width="50%">
			<fieldset >
	<legend style="font-size: larger; "  ><b><hdiits:caption captionid="AddPay.DetailApplicant" bundle="${AddPay}"/></b></legend>
	...
	<table id="AddPAyRequest1" width="100%" align="center">
		...
		<tr>
			...
			<td width="25%"><hdiits:text captionid="AddPay.UserSanctionAmt"
				name="UserSancAmt" id="UserSancAmt" bundle="${AddPay}" /></td>
		...
		<c:if test="${vl=='S'}">
			...
			<tr>
				...
				<td width="25%"><hdiits:textarea captionid="AddPay.Explanation"
					...
					default="${ReqPayVoGen.explanation}" readonly="true" /></td>
			</tr>
		</c:if>
		<c:if test="${vl=='U'}">
			<tr>
			...
			<tr>
				<td width="25%"><b><hdiits:caption
					captionid="AddPay.Explanation" bundle="${AddPay}" /></b>&nbsp;&nbsp;</td>
				<td width="25%"><hdiits:textarea captionid="AddPay.Explanation"
					bundle="${AddPay}" name="Explanation2"
					default="${ReqPayVoGen.explanation}" readonly="true" /></td>
			</tr>
		</c:if>
	...
	<hdiits:jsField jsFunction="verify()" name="validation"/>
...
<c:if test="${ReqPayVoGen.approveFlag=='A'}">
	<script>	
document.getElementById('AddPAyRequest1').style.display='none';
//document.getElementById('frmApprove1').style.display = 'none';
//document.getElementById('frmForward').style.display = 'none';
</script>
</c:if>

<c:if test="${ReqPayVoGen.approveFlag=='P'}">
	<script>
	document.getElementById('reqDetail').style.display='';
	document.getElementById('ApprDetail').style.display='none';
	
	</script>
	<c:if test="${cFlag ne 'true'}">
		<script>
		//document.getElementById('frmSub').style.display='';
		//document.getElementById('frmApprove1').style.display = '';
		//document.getElementById('frmForward').style.display = '';	
		</script>
	</c:if>

</c:if>

<c:if test="${cFlag=='true'}">
	<script>
		//document.getElementById('ApprDetail').style.display='none';
		//document.getElementById('reqDetail').style.display='none';
	...
	//	document.getElementById('frmForward').style.display = 'none';
		...
		document.getElementById('AddPAyRequest1').style.display='none';
		document.getElementById('reqDetail').style.display='';
		document.getElementById('ApprDetail').style.display='';
		</script>
	</c:if>

</c:if>

<c:if test="${ReqPayVoGen.compFlag == 'U'}">
	<script>
	document.getElementById("UserCal").checked=true;
	document.getElementById("UserSancAmt").value="${ReqPayVoGen.userAmt}";
