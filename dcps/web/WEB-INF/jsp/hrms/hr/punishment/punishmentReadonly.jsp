...
<script>
			...
			function close_redirect()
			{
				...
				document.frmNC.action="./hdiits.htm?actionFlag=validateLogin&theme=hdiits";
				document.frmNC.submit();
			}
...
<hr>			  
 <hdiits:fieldGroup titleCaptionId="PS.KV" bundle="${commonform}" id="PS.PS.KVId" collapseOnLoad="false">
<TABLE class=tabtable>				  
