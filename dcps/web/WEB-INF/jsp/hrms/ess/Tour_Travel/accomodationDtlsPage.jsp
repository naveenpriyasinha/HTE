...
function submitDtls()
{
	...
	var urlstyle="hdiits.htm?actionFlag=submitAccomDtls";
...
function populateForm()
{
	if (xmlHttp.readyState == 4) 
	{
		...
		document.getElementById('acomType').value=getXPathValueFromDOM(xmlDOM,'accomType');
		...
		var accomType=getXPathValueFromDOM(xmlDOM,'accomType');
		...
		}else if(accomType=='321556'||accomType=='321550')
		{
			...
			document.getElementById('cktChrage').value=getXPathValueFromDOM(xmlDOM,'cktHousetCharge');
			document.getElementById('hotelPaidTb').style.display="none"	
...
<table id='tripdtls' border="1" cellpadding="0" width="100%"
							...
							<tr>
								<td><label id="city">${arrDt}</label> </td>
								<td><label id="arrivalDt">${arrDt}</label> </td>
								<td><hdiits:text name="arrTm" size="5" readonly="true" default="${arrTm}" /></td>
								<td><label id="departDt">${departDt}</label> </td>
								<td><hdiits:text name="departTm" size="5" readonly="true" default="${departTm}" /> </td>
							</tr>
</table>
</center>
<br>
...
<table bgcolor="#386CB7" align="center" width="100%" id="journeyLable">
	<tr align="center">
		<td><font class="Label3" align="center"><u><font
			...
			captionid="HRMS.AccomDetais" bundle="${commonLables1}" /></b></u><span class="UserText"
...
<tr>
	<td>From Date</td>
	<td><hdiits:dateTime name="fromDate" captionid="HRMS.DummyArrDt" bundle="${commonLables1}" mandatory="true" onblur="fromdatecheck(this)"/> </td>
	<td>To Date</td>
	<td><hdiits:dateTime name="toDate" captionid="HRMS.DummyDeprDt" bundle="${commonLables1}" mandatory="true" onblur="tocheckdate(this)" /></td>
</tr>
<script>
...
<tr>
	<td>From Time</td>
	<td>
	<hdiits:text name="frmTime" id="frmTime" mandatory="true" maxlength="5" onblur="fromtimecheck(this)" size="5"/></td>
	<td>To Time</td>
	<td><hdiits:text name="toTime" id="toTime" mandatory="true" maxlength="5" onblur="totimecheck(this)" size="5"/></td>
</tr>
<tr>
	<td>
		Accomodation:
	...
	<td colspan="1">
	<hdiits:select name="acomType" size="1" caption="acomType" id="acomType" onchange="changeAcomType(this)" tabindex="2" style="">
...
<tr>
	<td>
		<table id="govPaidTb" style="display: none">
			<tr>
				<td>
				  Whether Boarding is provided free by Government 
				  </td>
				  <td>
				  	Yes<input name="GovbordingBt" type="radio"  id="GovbordingBt" value="Y"  /> 
				  	No<input name="GovbordingBt" type="radio" checked="checked" id="GovbordingBt" value="N"   /> 
				  	
				  </td>
			</tr>
			<tr>
				<td>
				  Whether Lodging is provided free by Government :  
				 </td>
				 <td> 
				  	Yes<input name="GovlodgingRt" type="radio"  id="GovlodgingRt" value="Y"  /> 	
				  	No<input name="GovlodgingRt" type="radio" checked="checked" id="GovlodgingRt" value="N"  /> 
				  </td>
			</tr>
		</table>
	</td>	
...
<tr>
	<td>
		<table id="cktHouseTb" style="display: none">
			<tr>
				<td>Did you stay in Circuit house :  </td>
				<td>
					Yes	<input type="radio" name="cktHouse" id="cktHouse" value="Y" />
				  	No	<input type="radio" name="cktHouse" id="cktHouse" value="N" checked="checked" />
				</td>
			</tr>
			<tr>
				<td>
				...
				<td>
					<hdiits:number name="cktChrage" id="cktChrage"/>
				</td>
			</tr>
		</table>
	</td>
...
<tr>
	<td>
		<table id="hotelPaidTb" style="display: none">
			<tr>
				<td>  Lodging/Boarding claimed :  </td>
				<td>
					Yes	<input type="radio" name="hotelBordingBt" id="hotelBordingBt" value="Y"/>
				  	No	<input type="radio" name="hotelBordingBt" id="hotelBordingBt" value="N" checked="checked"/>
				 </td>
			</tr>
			<tr>
				<td>
				...
				<td>
					...
					<hdiits:number name="hotelCharge" id="hotelCharge"/>
				</td>
			</tr>
		</table>
	</td>
...
<center>
	<hdiits:button name="addData" type="button" value="Add"  onclick="addDataInAcomTable()" />
	<hdiits:button name="save" id="save" type="button" value="Save"  onclick="saveData(this)" style="display:none"/>
</center>
...
<table id="acomDtls" border="1" cellpadding="0" width="100%"
							...
							style="background: #eeeeee;padding: 2px">
<tr class="datatableheader">
			<td colspan="1"><hdiits:caption captionid="HRMS.SRNO" bundle="${commonLables1}" /></td>
			<td colspan="1"><hdiits:caption captionid="HRMS.FromDate" bundle="${commonLables1}" /></td>
			<td colspan="1"><hdiits:caption captionid="HRMS.FromTime" bundle="${commonLables1}" /></td>
			<td colspan="1"><hdiits:caption captionid="HRMS.ToDate" bundle="${commonLables1}" /></td>
			<td colspan="1"><hdiits:caption captionid="HRMS.ToTime" bundle="${commonLables1}" /></td>
			<td colspan="1"><hdiits:caption captionid="HRMS.Accomodation" bundle="${commonLables1}" /></td>
			<td colspan="1"><hdiits:caption captionid="HRMS.LodingClaim" bundle="${commonLables1}" /></td>
			<td colspan="1"><hdiits:caption captionid="HRMS.LodingCharge" bundle="${commonLables1}" /></td>
			<td colspan="1"><hdiits:caption captionid="HRMS.FreeBording" bundle="${commonLables1}" /></td>
			<td colspan="1"><hdiits:caption captionid="HRMS.FreeLodging" bundle="${commonLables1}" /></td>
			<td colspan="1"><hdiits:caption captionid="HRMS.CktHouseStay" bundle="${commonLables1}" /></td>
			<td colspan="1"><hdiits:caption captionid="HRMS.CktHouseStay" bundle="${commonLables1}" /></td>
			<td colspan="1"><hdiits:caption captionid="HRMS.Description" bundle="${commonLables1}" /></td>
...
<CENTER>
	<hdiits:button name="submitBt" id="submitBt" type="button" value="Submit" onclick="submitDtls()" />
	<hdiits:button name="Close" id="Close" type="button" value="Close"  onclick="closewindow()" />
</CENTER>
		...
		<hdiits:hidden name="journeyId" id="journeyId" />
		
		<hdiits:hidden name="srNo"  />
</hdiits:form>
							
<c:forEach items="${dtls}" var="details">
<script>
	
	document.getElementById('journeyId').value="${details.tourRowId}";
	
	document.getElementById('city').innerHTML="${details.travelToPlace.cityName}";
