...
var leavetypeSelected="0"; // used to show EL Agreement Field.
...
<BR>
		...
		<hdiits:fieldGroup style="display:none" bundle="${leaveCaption}" expandable="false" collapseOnLoad="false" titleCaptionId="HRMS.Agreement" id="agreement">
		...
		<script type="text/javascript">				
			if(leavetypeSelected=='3_3_5' || leavetypeSelected=='3_3_6')
			{
	...
	<%@ include file="prevPenAppReq.jsp"%>
	<%@ include file="EmployeesOnLeaveReport.jsp"%>
		<jsp:include page="/WEB-INF/jsp/hrms/hr/Incharge/InchargeAttachement.jsp">
		<jsp:param name="USERID" value="${appliedLeaveData.orgUserMstByUserId.userId}"/>
		<jsp:param name="APPLICATION_MAP_ID" value="${appliedLeaveData.leaveid}"/>
		<jsp:param name="FROM_DATE" value="${fromDate}"/>
		<jsp:param name="TO_DATE" value="${toDate}"/>
		<jsp:param name="APPLICATION_NAME" value="Leave"/>
		</jsp:include>
