...
<TABLE class=tabtable>			    
			    <TR>
				    ...
				    <TD width="25%"><hdiits:text name="outcm_meetdate" default="${outcmMeetDate}" readonly="true" style="color: black; font-family: Verdana; font-weight: bold; font-size: 12px; background-color: lightblue;"/></TD>
				  	<TD width="25%"><hdiits:caption captionid="PS.EXACTTIMEOFMEETING1" bundle="${commonform}"/></TD>
				    <TD class=fieldLabel ><hdiits:text name="outcm_meetTime" default="${outcmMeetTime}" readonly="true" style="color: black; font-family: Verdana; font-weight: bold; font-size: 12px; background-color: lightblue;"/></TD>
				    <TD class=fieldLabel width="25%"></td>
					<TD class=fieldLabel width="25%"></td>	
...
<TABLE class=tabtable>	
			  ...
			  <TR>
					...
					<TD class=fieldLabel width="25%"><hdiits:textarea name="decisionDtls" default="${outcomeDtls}" readonly="true" rows="6" cols="60" style="color: black; font-family: Verdana; font-weight: bold; font-size: 12px; background-color: lightblue;"></hdiits:textarea></td>
					<TD class=fieldLabel width="25%"></td>
					<TD class=fieldLabel width="25%"></td>					
				</tr>	
				 <TR>
				    ...
				    <c:if test="${orderNo!='0' }">
				    <TD width="25%"><hdiits:text name="orderNo" default="${orderNo}" readonly="true" style="color: black; font-family: Verdana; font-weight: bold; font-size: 12px; background-color: lightblue;"/></TD>
				    </c:if>
				    <c:if test="${orderNo=='0' }">
