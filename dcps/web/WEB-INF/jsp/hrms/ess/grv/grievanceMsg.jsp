...
<!--<TABLE class=tabtable>
  ...
  <tr bgcolor="#386CB7">
						...
						<font color="#ffffff">
						<b><hdiits:caption captionid="PS.REQUESTMSG1" bundle="${commonform}"/><hdiits:caption captionid="PS.GREVN" caption="${id }"/>
...
<table width="100%" align="center">
  ...
  <tr  ></tr>
    ...
    <tr><th align="center"><b><hdiits:caption captionid="PS.SENTBACKMSG" bundle="${commonform}"/><hdiits:caption captionid="PS.GREVN" caption="${name}"/></b>
    </th></tr>
  <tr></tr>
