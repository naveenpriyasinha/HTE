...
<hdiits:form name="insExprFrm" validate="true" method="POST" 
	action="hrms.htm?actionFlag=addUpdateDeducExpMaster&edit=N" encType="multipart/form-data">

<div id="tabmenu">
	<ul id="maintab" class="shadetabs">
		<li class="selected"><a href="#" rel="tcontent1"><b><hdiits:caption captionid="EX.insertDeducExpressionMaster" bundle="${commonLables}"></hdiits:caption></b></a></li>
	</ul>
	</div>
...
<tR><td></td></tR>
 <TR>
			...
			<b><hdiits:caption captionid="EX.deducType" bundle="${commonLables}"></hdiits:caption></b>
				...
				<td><hdiits:select  captionid="EX.deducType" bundle="${commonLables}" name="deductionType" mandatory="true"  validation="sel.isrequired"> 
						<hdiits:option value="Select">-----------Select-----------</hdiits:option>
						<c:forEach var="deduc" items="${deducTypeList}">
				    					<option value=<c:out value="${deduc.deducCode}"/>>
										<c:out value="${deduc.deducName}"/></option>
						</c:forEach>		
