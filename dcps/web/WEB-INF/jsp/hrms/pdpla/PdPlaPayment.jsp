WC<%@ include file="../core/include.jsp" %>
...
<head>
	...
	<script type="text/javascript" src="script/onlinebillprep/Common.js"> </script>
		...
		<hdiits:table align = "center" width = "700px">
			<hdiits:tr>
				<hdiits:td align = "center" colspan = "4"><h2>PD/PLA Payment</h2></hdiits:td>
			</hdiits:tr>
		</hdiits:table>
		<hdiits:form name = "PdPlaPayment" method = "post" validate = "true" action="./ifms.htm?actionFlag=ShowPaymentData">
		<hdiits:table align = "center" width = "700px">
			<hdiits:tr>
				<hdiits:td><fmt:message key="PAYMENT.DATE_PAYMENT" bundle="${pdplaLabels}"></fmt:message>:</hdiits:td>
				<hdiits:td><input type = "text" name = "txtDatePymt"/><img src=images/CalendarImages/ico-calendar.gif width=20 onClick=window_open('txtDatePymt',375,570)></hdiits:td>
			</hdiits:tr>
			<hdiits:tr>
			...
			<hdiits:tr>
				...
				<hdiits:td><input type = "text" name = "txtMajorHead" id = "id_txtMajorHead"/></hdiits:td>
				<hdiits:td><fmt:message key="CMN.MINOR_HEAD" bundle="${pdplaLabels}"></fmt:message>:</hdiits:td>
				<hdiits:td><input type = "text" name = "txtMinorHead" id = "id_txtMinorHead"/></hdiits:td>
			</hdiits:tr>
			<hdiits:tr>
				<hdiits:td><fmt:message key="CMN.DEPT" bundle="${pdplaLabels}"></fmt:message>:</hdiits:td>
				<hdiits:td><input type = "text" name = "txtDept" id = "id_txtDeptName"/></hdiits:td>
			</hdiits:tr>
			<hdiits:tr>
				<hdiits:td><fmt:message key="PAYMENT.CHQ_NO" bundle="${pdplaLabels}"></fmt:message>.:</hdiits:td>
				<hdiits:td><input type = "text" name = "txtCheque"/></hdiits:td>
			</hdiits:tr>
			<hdiits:tr>
			...
			<hdiits:tr>
				<hdiits:td></hdiits:td>
				<hdiits:td colspan = "2">
					<input type = "submit" name = "submit" id="submit" value = "Save" size = "20"/>&nbsp;&nbsp;&nbsp;
					<input type = "submit" name = "reset" id="reset" value = "Cancel" size = "20"/>&nbsp;&nbsp;&nbsp;
					<input type = "submit" name = "Retrieve" id="Retrieve"  value = "Retrieve" size = "20"/>
				</hdiits:td>
				<hdiits:td></hdiits:td>
			</hdiits:tr>
		</hdiits:table>
