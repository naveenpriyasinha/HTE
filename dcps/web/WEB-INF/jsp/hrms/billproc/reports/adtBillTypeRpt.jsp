		...
		<hdiits:form name="frmTrackRpt" validate="true">
			<hdiits:table width="100%">
			  <hdiits:tr>
				  <hdiits:td>
					  <p align="center">
					  	<FONT class=titles>Auditor : B.G. Chudasama</font>
				  </hdiits:td>
			  </hdiits:tr>
				...
				<hdiits:td>
					<hdiits:table align="center" width="100%">
						<hdiits:tr>
							...
							<hdiits:td>
								<fmt:message key="CMN.DESCRIPTION" bundle="${billprocLabels}" ></fmt:message>
								<jsp:include page="/common/include/billproc/sort.jsp" />								
							</hdiits:td>
							
							<hdiits:td>
								<fmt:message key="ADT.TOTAL_BILLS" bundle="${billprocLabels}" ></fmt:message>
								<jsp:include page="/common/include/billproc/sort.jsp" />								
							</hdiits:td>
							<hdiits:td>
						...
						<hdiits:tr>
							...
							<hdiits:td>G33</hdiits:td>							
							<hdiits:td>Pay Bill</hdiits:td>
							<hdiits:td>4</hdiits:td>
							<hdiits:td>20000.00</hdiits:td>							
						</hdiits:tr>
						<hdiits:tr>
							<hdiits:td colspan="4" align="right">Total &nbsp;&nbsp;</hdiits:td>
							<hdiits:td>14</hdiits:td>
