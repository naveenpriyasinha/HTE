...
<html>
	<head>
		...
		<script language="javascript">
			function showAdvice()
			{
//				alert("Inside show Advice");
				url="ifms.htm?viewName=cntrGenAdvVchr";
...
<body>
<hdiits:form name="frmCntrDisptchBills" validate="true">
<hdiits:table width="100%" align="center">
	<hdiits:tr>
		<hdiits:td align="center">
			<b>Treasury > Bill Processing > Counter Branch > Dispatch Cheques</b>
		</hdiits:td>
	</hdiits:tr>
	...
	<hdiits:tr>
		<hdiits:td align="center">
			<b>DISPATCH CHEQUES</b>
		</hdiits:td>
	</hdiits:tr>

	<hdiits:tr>
				<hdiits:td>		
					<jsp:include page="../common/include/billproc/chqSearch.jsp" />
	...
	<hdiits:tr>
		<hdiits:td>
			<hdiits:table width="100%" align="center">
   				...
   				<% //for(int i=0;i<4;i++) { %>
   				<hdiits:tr> 
   					<hdiits:td><hdiits:checkbox name="chkSelect1" value=""></hdiits:checkbox></hdiits:td>
   					<hdiits:td>10023568</hdiits:td>
...
<!--    					<hdiits:td>&nbsp;</hdiits:td>	 -->
  	...
  	<hdiits:tr>
  		<hdiits:td>
  			<center>
   			   	<hdiits:button type="button" name="btnDispatch" value="Dispatch" onclick="javascript:showAdvice();"></hdiits:button>
