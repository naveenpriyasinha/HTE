...
<c:set var="Map" value="${resultObj.resultValue}" > </c:set>	  
<c:set var="List" value="${Map.sgdataList}" > </c:set>
...
<div class="tabcontentstyle">	  
 ...
 <div id="tcontent1" class="tabcontent"> 
     ...
     <display:table name="${List}" pagesize="12" requestURI=""
  defaultsort="1" defaultorder="ascending" id="row" export="true" style="width:100%">
     ...
     <display:column property="radModuleMst.modId" class="tablecelltext" titleKey='MOD_ID' sortable="true" headerClass="datatableheader" />
...
<BR>
      ...
      <a href= "./hdiits.htm?actionFlag=getdbid">   <fmt:message key="SEARCH_AGAIN" />   <BR>
