...
<hdiits:hidden name="actionFlag" default="getTrainingDetails"/>
...
<fmt:message key="TR.SelectEditTraining"  bundle="${trngLables}" var="trngTitle"></fmt:message>
<TABLE class="tabtable">
<tr>  
	<td class="fieldLabel" colspan="6">
	<jsp:include page="trainingMstSearch.jsp">
