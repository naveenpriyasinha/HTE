...
function GoToNewPageTraining() 
{
	...
	window.open(requeswtURL+"?viewName=SelectedEmplistEdit","Show",urlstyle); 
...
<table width="100%">
				...
				<tr>
					...
					<td class="fieldLabel" width="25%">
						<hdiits:button type="button" captionid="TR.search" bundle="${selectTrngScheduleToAddEmp}" name="btnSearchTraining" onclick="GoToNewPageTraining()" readonly="${readOnly}"/>
					</td>
