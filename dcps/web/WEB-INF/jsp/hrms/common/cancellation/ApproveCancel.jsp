...
<c:set var="fwdTo" value="${resultValue.fwdTo}">
</c:set>
...
<table width="100%" align="center" 	style="margin: 5px 0px;  font-family: arial; color: #333333;border: solid 1px #6B2700; width: 50%; clear: center;">
	<tr>
		...
		<b><fmt:message key="CAN.NEWREQUESTNO" bundle="${msgBundle}"/> :</b>
		</td>
		<td align="left">${resultValue.newJobId}
		</td>
	</tr>
		<tr>
		<tr>
		<td align="right">
		<b><font color="red">*</font></b>
		<b><fmt:message key="CAN.OLDREQUESTNO" bundle="${msgBundle}"/> :</b>
		</td>
		...
		<tr align="center">
		<td align="right">
		<b><font color="red">*</font><fmt:message key="CAN.FWDTO" bundle="${msgBundle}"/> :</b>	
			</td>
		<td  align="left" >
		 ${fwdTo}
		</td>
		<tr align="center">
		<td align="right">
		<b><font color="red">*</font><fmt:message key="CAN.STATUS" bundle="${msgBundle}"/> :</b>	
			</td>
		<td  align="left" >
		 <hdiits:caption captionid="Can.Pending" bundle="${msgBundle}"/>
		</td>
	</tr>
