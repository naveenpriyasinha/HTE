...
<fieldset class="tabstyle">
	<jsp:include page="OfflineArrearAttachment.jsp">
		<jsp:param name="attachmentName" value="File" />
		<jsp:param name="formName" value="uploadForm" />
		<jsp:param name="attachmentType" value="Document" />
		<jsp:param name="attachmentTitle" value="Offline Entry" />
	...
	<table width="20%" align="center">
		<tr>
			<td>
				...
				<hdiits:button name="btnUpload" id="btnUpload" type="button"  value="Upload File" onclick="callReadExcel()"/>
			</td>
		</tr>
</table>
...
<script type="text/javascript">
	function callReadExcel()
	{
			...
			document.uploadForm.action='ifms.htm?actionFlag=readGPFArrearsFile';
