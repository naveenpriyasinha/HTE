...
<c:set var="WithdrawalDetail" value="${resValue.WithdrawalDetail}"/>
<fieldset ><legend><fmt:message key="CMN.WITHDRAWALS" bundle="${gpfLabels}"></fmt:message></legend>
<display:table list="${WithdrawalDetail}" size="${totalRecords}" pagesize="10"  id="vo" requestURI=""cellpadding="4" style="width:100%" >
	<display:setProperty name="paging.banner.placement" value="bottom" />
		...
		<display:column style="text-align: left;" class="oddcentre" titleKey="CMN.SANCAUTHORITYNAME" headerClass="datatableheader" value="${vo[4]}"></display:column>
		<fmt:formatDate value="${vo[5]}" var="sancDate" pattern="dd/MM/yyyy"/>	
