...
<c:set var="identLetter" value="${resValue.DisplayIdentLetterString}"></c:set>
<input type="hidden" id="hdnIdentLetter" name="hdnIdentLetter" value="${resValue.PrintIdentLetterString}"/>
<script>
function printIdentLetter()
{
    ...
    var printString = document.getElementById("hdnIdentLetter").value;
...
<hdiits:form name="frmPrintIdentLetter" validate="false">
<br>
<div align="center"><h5><fmt:message key="PPMT.IDENTLETTER" bundle="${pensionLabels}" ></fmt:message></h5></div>
	...
	<div align="center">
	<hdiits:button type="button" captionid="PPMT.PRINTREPORT" bundle="${pensionLabels}" id="btnPrintReport" name="btnPrintReport" onclick="printIdentLetter()" classcss="bigbutton"/>
