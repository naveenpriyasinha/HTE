...
<input type="hidden" name="hidPpoScanCopy" id="hidPpoScanCopy" >
<input type="hidden" name="attachmentName1" id="attachmentName1" >

<fieldset  style="width:100%" class="tabstyle">
	<legend id="headingMsg"><b><fmt:message key="PPMT.PHOTOORSIGN" bundle="${pensionLabels}"></fmt:message></b></legend>
	<table width="100%"> 	
		<tr>
		
			<td>
				<div id="divPhoto">
						<jsp:include page="/WEB-INF/jsp/pensionpay/pensionAttachment.jsp">
							<jsp:param name="attachmentName" value="Photo"/>
						    <jsp:param name="formName" value="InwardPensionerTabForm"/>
			...
			<td>
				<fieldset class="tabstyle" style="width: 80%;" >
					<legend id="headingMsg"><b> <fmt:message key="PPMT.PHOTO" bundle="${pensionLabels}"></fmt:message></b></legend>
						...
						<c:when test="${resValue.PhotoId != null}" >
							<div id="prewPhoto" style="width: 180px;height: 150px;">
								<a href="#" id="Photo" name="Photo" onmouseout="hidImg()"  onmouseover="showImg(this)"  >	
									<img id="imgPnsnrPhoto" style="width: 180px;height: 150px;"  src="ifms.htm?actionFlag=viewAttachment&attachmentId=${resValue.PhotoId}&attachmentSerialNumber=${resValue.PhotosrNo}">
								</a>
								<script type="text/javascript">
			...
			<td>
				<fieldset class="tabstyle" style="width: 80%;" >
					<legend id="headingMsg"><b><fmt:message key="PPMT.SIGN" bundle="${pensionLabels}"></fmt:message> </b></legend>
						<c:choose>
						<c:when test="${resValue.SignId != null}" >
							<div id="prewSign" style="width: 180px;height: 150px;">
								<a href="#" name="Sign" id="Sign" onmouseout="hidImg()"  onmouseover="showImg(this)"  >	
									<img id="imgPnsnrSign" style="width: 180px;height: 150px;" src="ifms.htm?actionFlag=viewAttachment&attachmentId=${resValue.SignId}&attachmentSerialNumber=${resValue.SignsrNo}">
								</a>
								<script type="text/javascript">
...
<fieldset  style="width:100%" class="tabstyle">
	<legend id="headingMsg"><b><fmt:message key="PPMT.PPOSCANCOPY" bundle="${pensionLabels}"></fmt:message></b></legend>
	<table width="100%"> 
<tr>
		<td>
	    	<jsp:include page="/WEB-INF/jsp/common/attachmentPage.jsp">
				...
				<jsp:param name="formName" value="InwardPensionerTabForm" />
				<jsp:param name="attachmentType" value="Document" />
				<jsp:param name="attachmentTitle" value="Scanned PPO" />
