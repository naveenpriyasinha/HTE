...
{	
    ...
    col3<%=request.getParameter("attachmentName")%>.innerHTML='<a class="removeLink" onClick="delRow<%=request.getParameter("attachmentName")%>(this,'+delRowNum+')" target="target_upload<%=request.getParameter("attachmentName")%>">Remove</a> / <a href="#" onClick="viewRow1<%=request.getParameter("attachmentName")%>(this,'+ delRowNum +')">View</a>'; 			
	}
	else
	{
...
{
	formName = "${formName}";
	if(document.getElementById("desc<%=request.getParameter("attachmentName")%>").value=="")
	{
		alert("File description required");
		return false;
	}
...
// 			var fileDescription = document.forms[formName].desc<%=request.getParameter("attachmentName")%>.value;
   	...
   	{
   		alert("You Cant Add MoreThan One <%=request.getParameter("attachmentName")%>");
		return false;
   	}
}
...
//	    	col1<%=request.getParameter("attachmentName")%>.innerHTML=document.forms[formNameGlobalVar<%=request.getParameter("attachmentName")%>].desc<%=request.getParameter("attachmentName")%>.value;
	    ...
	    col3<%=request.getParameter("attachmentName")%>.innerHTML='<a class="removeLink" onClick="delRow<%=request.getParameter("attachmentName")%>(this,'+rowNumber + ')" target="target_upload<%=request.getParameter("attachmentName")%>">Remove</a> / <a href="#" onClick="viewRow1<%=request.getParameter("attachmentName")%>(this,'+ rowNumber +')">View+'rowNumber'+</a>'; 			
		<%}else{%>
		col3<%=request.getParameter("attachmentName")%>.innerHTML='<a class="removeLink" onClick="delRow<%=request.getParameter("attachmentName")%>(this)" target="target_upload<%=request.getParameter("attachmentName")%>">Remove</a> / <a href="#" onClick="viewRow1<%=request.getParameter("attachmentName")%>(this)">View</a>'; 			
		<%}%>
...
function delRow<%=request.getParameter("attachmentName")%>(rowNumber)
{
	...
	if(confirm('<fmt:message bundle="${AttachmentLables}" key="REMOVE_ALTER_MSG"/>'))
	{
		...
		try
		{
			...
			if('desc<%=request.getParameter("attachmentName")%>'=='descPhoto')
			{
			 	document.getElementById('desc<%=request.getParameter("attachmentName")%>').value="Photo";
			}
			else
			{
				document.getElementById('desc<%=request.getParameter("attachmentName")%>').value="Signature";
			}
		}
		catch(qq)
		{
...
function viewRow<%=request.getParameter("attachmentName")%>(src,rowNumber)
{
	...
	try
	{
		...
		newWindow.close();
	 	var tempattachName = '<%=request.getParameter("attachmentName")%>';
...
function viewRow1<%=request.getParameter("attachmentName")%>(src,rowNumber)
{
...
function insRowEdit<%=request.getParameter("attachmentName")%>()
{
		...
		if(cmnAttachmentMst != null)
		{
		    ...
		    col3<%=request.getParameter("attachmentName")%>.innerHTML='<a class="removeLink" onClick="removeRow<%=request.getParameter("attachmentName")%>(\'<%=removeURL%>\',this)" target="target_upload<%=request.getParameter("attachmentName")%>">Remove</a> / <a href="<%=viewURL%>">View</a>'; 			
...
<!--   
 ...
 <tr  >
 <td rowspan="2" >
 <hdiits:button type='button' name='submitButton${submitName}' id='submitButton${submitName}' caption='Upload${submitName}'  onclick='startStatusCheck${submitName}()' style='width:100px;' />
 </td>
<!-- 
