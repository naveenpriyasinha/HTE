...
<%}%>
 <td colspan="3" align="center">
	 <c:set var="submitName" value='<%=request.getParameter("attachmentName")%>'></c:set>
		 <hdiits:button type="button" name="submitButton${submitName}" id="submitButton${submitName}" classcss="bigbutton" captionid="ADD_FILE" bundle="${AttachmentLables}" onclick="startStatusCheck${submitName}('${formName}')" />
 <%
