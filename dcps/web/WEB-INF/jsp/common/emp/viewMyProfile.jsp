  ...
  <script type="text/javascript" src="common/script/tabcontent.js">
        ...
        <table align="center" width="10%" cellpadding=5>	    
		 ...
		 <c:forEach var="employee" items="${empList}" >	  	
			...
			<tr>
			<td align="right" >
		  	<A href="common/images/EmployeeImage/<c:out value='${employee[0]}'/>.jpg" target="_blank" >
			<img src="common/images/EmployeeImage/<c:out value='${employee[0]}'/>.jpg" height=100 widht=100 border="0"></A>
			</td>
			<td align="left">
