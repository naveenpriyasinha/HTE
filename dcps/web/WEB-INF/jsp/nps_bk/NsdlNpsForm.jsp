...
<script type="text/javascript">
	...
	function getNsdlEntries() {
		...
		if (cmbTr == -1) {
			...
			self.location.href = 'ifms.htm?actionFlag=loadNPSNSDLForm&yearId='
	...
	function createTextFiles() {
		...
		url = 'ifms.htm?actionFlag=genNsdlTxtFile&yearId=' + yearId
				+ '&monthId=' + monthId + '&subTr=' + subTr + '&ifDeputation='
				+ cmbDeputation;
		showProgressbar();
		self.location.href = url;
	...
	function createTextFilesDeputaion() {
		...
		url = 'ifms.htm?actionFlag=genNsdlTxtFileForDeputation&yearId='
				+ yearId + '&monthId=' + monthId + '&subTr=' + subTr
				+ '&ifDeputation=' + cmbDeputation;
		;
		showProgressbar();
		self.location.href = url;
			...
			<div class="scrollablediv" style="width: 70%; overflow: auto;">
				<display:table list="${empList}" id="vo"
					...
					<display:column style="text-align:center" titleKey="CMN.SEVARTHID"
						...
						value="${vo.empSevaarthId}">
					</display:column>

					<display:column style="text-align:center"
						titleKey="CMN.NAMEOFEMPLOYEE" headerClass="datatableheader"
						class="oddcentre" value="${vo.empEmployeeName}">
					</display:column>
					...
					<display:column style="text-align:center"
						titleKey="CMN.SUPERANNUATIONDATE" headerClass="datatableheader"
						class="oddcentre" value="${vo.empServiceEndDate}">
					</display:column>
				...
				<div align="left">
					<table style="width: 100%;" align="right">
						<tr>
							<td style="font-size: large; color: #FF0000;">Note :-> Above
								Employee List Found for Retired Employee.</td>
						</tr>
						<tr>
						</tr>
						<tr>
							<td style="font-size: large;"><u>Do Below Step By Step
									Procedure : </u></td>
						</tr>
						<tr>
						</tr>
						<tr>
							<td style="font-size: large;">1. Deactivate PRAN No for
								Retired Employee.(PATH : Worklist > NPS > Data Updation Utility
								> Pran Activation and Deactivation )</td>
						</tr>
						<tr>
							<td style="font-size: large;">2. Then Re-Generate File once
								again.</td>
						</tr>
					</table>
		...
		<table align="center">
			<tr>
				<c:if test="${deputationFlag ==  '2'}">
					<td id="tdNonDep"><input type="button" id="createtxtButn"
						style="width: 100%" onclick="createTextFiles();" class="buttontag"
