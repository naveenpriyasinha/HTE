...
public class IncomeTaxSubReportDAOImpl extends DefaultReportDataFinder 
implements ReportDataFinder,ReportEventListener 
{
	...
	public Collection findReportData( ReportVO report, Object criteria ) throws ReportException
	{
		...
		report.setStyleList(URLStyleVO);
			...
			innerRow = new ArrayList();
			innerRow.add("Accounts Officer");
			innerData.add(innerRow);
			innerRow = new ArrayList();
			innerRow.add("Directorate Of Accounts and Treasuries");
			innerData.add(innerRow);
			...
			DataList.add(row);
			  ...
			  + year + "-" + (month + 1) + "-" + day + " " + hour +":" +minute+":"+second+"."+millysecond);
