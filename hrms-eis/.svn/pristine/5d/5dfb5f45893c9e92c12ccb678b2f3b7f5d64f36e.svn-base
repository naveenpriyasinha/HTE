...
/**
 * HrEisEmpFamilyDtlsHst generated by hbm2java
 */
public class HrEisFamilyDtlHst implements java.io.Serializable {

	// Fields    

	private HrEisFamilyDtlHstId id;
	...
	/** default constructor */
	public HrEisFamilyDtlHst() {
	}

	/** minimal constructor */
	public HrEisFamilyDtlHst(HrEisFamilyDtlHstId id,
	...
	public HrEisFamilyDtlHst(HrEisFamilyDtlHstId id,
			...
			String fmLastName, Date fmDateOfBirth,Date startDate, Date endDate,
			...
			String annualIncome,
			String dependentOrNot, Date dateOfDemise, String otherOccupation,
	...
	// Property accessors
	public HrEisFamilyDtlHstId getId() {
		return this.id;
	}

	public void setId(HrEisFamilyDtlHstId id) {
		this.id = id;
	}
