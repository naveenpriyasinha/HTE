...
public class FormBSubReportDAOImpl extends DefaultReportDataFinder 
implements ReportDataFinder,ReportEventListener 
{
	...
	public Collection findReportData( ReportVO report, Object criteria ) throws ReportException
	{
		...
		report.setStyleList(URLStyleVO);
			...
			dataStyle = new StyledData();
			dataStyle.setStyles(leftBoldStyleVO);
			dataStyle.setData("1.Certified that the name, amounts of individuals deductions & the total shown in column (6) have been checked by reference");
			dataStyle.setColspan(2);
			row.add(dataStyle);
			DataList.add(row);
			...
			dataStyle = new StyledData();
			dataStyle.setStyles(leftBoldStyleVO);
			dataStyle.setData("to the bill, vide. paragraph 224 of the Audit Manual");
			dataStyle.setColspan(2);
			row.add(dataStyle);
			DataList.add(row);
			...
			dataStyle = new StyledData();
			dataStyle.setStyles(leftBoldStyleVO);
			dataStyle.setData("2.Certified that the rates of pay as shown in column(5) have been verified with the amounts actually drawn in the bill");
			dataStyle.setColspan(2);
			row.add(dataStyle);
			DataList.add(row);
