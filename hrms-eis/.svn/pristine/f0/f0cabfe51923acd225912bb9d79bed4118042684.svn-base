...
public class GPFSubReportDAOImpl extends DefaultReportDataFinder 
implements ReportDataFinder,ReportEventListener 
{
	...
	public Collection findReportData( ReportVO report, Object criteria ) throws ReportException
	{
		...
		report.setStyleList(URLStyleVO);
			...
			dataStyle.setData("Certified that I have personally verified the correctness of the details in this schedule and they are found correct.");
			dataStyle.setColspan(2);
			row.add(dataStyle);
			DataList.add(row);
			...
			dataStyle = new StyledData();
			dataStyle.setStyles(leftBoldStyleVO);
			dataStyle.setData("For use of Audit Office");
			dataStyle.setColspan(2);
			row.add(dataStyle);
			DataList.add(row);
			...
			dataStyle = new StyledData();
			dataStyle.setStyles(centerboldStyleVO);
			dataStyle.setData("Date of Encashmment :");
			dataStyle.setColspan(2);
			row.add(dataStyle);
			DataList.add(row);
			...
			dataStyle = new StyledData();
			dataStyle.setStyles(leftBoldStyleVO);
			dataStyle.setData("1.Certified that the name, amounts of individuals deductions & the total shown in column (7) have been checked by reference to the bill, vide. paragraph 224 of the Audit Manual.");
			dataStyle.setColspan(2);
			row.add(dataStyle);
			DataList.add(row);
			...
			dataStyle = new StyledData();
			dataStyle.setStyles(leftBoldStyleVO);
			dataStyle.setData("2.Certified that the rates of pay as shown in column(3) have been verified with the amounts actually drawn in the bill.");
			dataStyle.setColspan(2);
			row.add(dataStyle);
			DataList.add(row);
			...
			dataStyle = new StyledData();
			dataStyle.setStyles(centerboldStyleVO);
			dataStyle.setData("Initials of the Auditor");
			dataStyle.setColspan(2);
			row.add(dataStyle);
			DataList.add(row);
			...
			dataStyle = new StyledData();
			dataStyle.setStyles(rightBoldStyleVO);
			dataStyle.setData("Treasury Officer / Pay & Accounts Officer");
			dataStyle.setColspan(2);
			row.add(dataStyle);
			DataList.add(row);
			...
			dataStyle = new StyledData();
			dataStyle.setStyles(centerboldStyleVO);
			dataStyle.setData("*******End of Report*******");
			dataStyle.setColspan(2);
			row.add(dataStyle);
			DataList.add(row);
