...
public class CoHsgSocSubReportDAOImpl extends DefaultReportDataFinder 
implements ReportDataFinder,ReportEventListener 
{
	...
	public Collection findReportData( ReportVO report, Object criteria ) throws ReportException
	{
		...
		report.setStyleList(URLStyleVO);
			...
			dataStyle.setData("1.Certified that total Recoveries shown in column (9) above agree with the amount actually recovered and shown in the body of the bill.");
			dataStyle.setColspan(2);
			row.add(dataStyle);
			DataList.add(row);
