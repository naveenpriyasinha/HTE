...
public class FORMXIISubReportDAOImpl extends DefaultReportDataFinder 
implements ReportDataFinder,ReportEventListener 
{
	...
	public Collection findReportData( ReportVO report, Object criteria ) throws ReportException
	{
		...
		report.setStyleList(URLStyleVO);
			...
			dataStyle.setData("Certified that the Total Recoveries shown above agrees with the amount actually");
			dataStyle.setColspan(2);
			row.add(dataStyle);
			DataList.add(row);
			...
			dataStyle = new StyledData();
			dataStyle.setStyles(leftBoldStyleVO);
			dataStyle.setData("recovered and shown in the body of the bill.");
			dataStyle.setColspan(2);
			row.add(dataStyle);
			DataList.add(row);
			...
			dataStyle = new StyledData();
			dataStyle.setStyles(leftBoldStyleVO);
			dataStyle.setData("Certified that the recoveries have been duly posted in Register of Advance (Form A ).");
			dataStyle.setColspan(2);
			row.add(dataStyle);
			DataList.add(row);
