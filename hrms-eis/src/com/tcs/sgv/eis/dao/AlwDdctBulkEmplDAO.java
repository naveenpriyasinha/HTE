...
public interface AlwDdctBulkEmplDAO extends GenericDao<HrPayEmpallowMpg, Long>{
	...
	public HrEisBankMst getBankMstVOByBranchCodeAndLang(String strBankCode, long langId); 
}
