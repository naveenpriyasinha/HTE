...
public class RltBillParty implements java.io.Serializable
{
    ...
    /** minimal constructor */
    public RltBillParty(Long billPartyId, Long billNo, Long createdUserId, Long createdPostId,
            String locationCode, Date createdDate)
    {
    ...
    /** full constructor */
    public RltBillParty(Long billPartyId, Long billNo, String partyCode, BigDecimal partyAmt,
            Long createdUserId, Long createdPostId, Date createdDate, Long updatedUserId,
            Long updatedPostId, Date updtaedDate, Long dbId, String partyName,
            String partyAddr, String accntNo, String locationCode)
    {
        this.billPartyId = billPartyId;
        this.billNo = billNo;
